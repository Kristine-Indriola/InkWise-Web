...
<main class="studio-layout">
    ...
    <section class="studio-canvas-area">
        ...
        <div
            ...
            data-front-canvas-width="<?php echo e($canvasWidthAttr ?? ''); ?>"
            data-front-canvas-height="<?php echo e($canvasHeightAttr ?? ''); ?>"
            data-front-canvas-unit="<?php echo e($canvasUnitAttr ?? ''); ?>"
            data-back-canvas-width="<?php echo e($canvasWidthAttr ?? ''); ?>"
            data-back-canvas-height="<?php echo e($canvasHeightAttr ?? ''); ?>"
            data-back-canvas-unit="<?php echo e($canvasUnitAttr ?? ''); ?>"
        ></div>
    </section>
</main>
...
<?php /**PATH C:\xampp\htdocs\InkWise-Web\ink-wise\resources\views/customer/order/studio.blade.php ENDPATH**/ ?>