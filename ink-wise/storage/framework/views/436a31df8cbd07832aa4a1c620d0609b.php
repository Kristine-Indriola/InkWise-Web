...
<body>
    ...
    <div class="auth-shell">
        <section class="auth-intro">
            ...
            <a href="<?php echo e(route('dashboard', ['modal' => 'login'])); ?>" class="intro-link">
        ...
        <section class="auth-pane">
            <div class="auth-card">
                <div class="auth-card__action">
                    <a href="<?php echo e(route('dashboard', ['modal' => 'login'])); ?>" class="link-quiet">
                        Sign in
                    </a>
                </div>
                ...
                <form method="POST" action="<?php echo e(route('customer.register')); ?>" id="customerRegisterForm" class="form-stack">
                    <?php echo csrf_field(); ?>
                    <?php if($errors->any()): ?>
                    ...
                    <div id="registerSteps" class="space-y-6">
                        <div class="register-step" data-step="1">
                            ...
                            <p class="support-text">
                                ...
                                <a href="<?php echo e(route('dashboard', ['modal' => 'login'])); ?>" class="link-primary">Sign In</a>
                            </p>
                        </div>
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <div class="mt-1 flex gap-2">
                                        <input type="email" name="email" id="registerEmail" value="<?php echo e(old('email')); ?>" required
                                ...
                                <div>
                                    ...
                                    <input type="text" name="verification_code" id="verificationCode" value="<?php echo e(old('verification_code')); ?>" required maxlength="6"
                        ...
                        <div class="register-step hidden" data-step="4">
                            ...
                            <label for="terms" class="mt-3 flex items-start gap-2 text-[11px] text-gray-500 leading-tight text-center justify-center">
                                <input type="checkbox" name="terms" id="terms" <?php echo e(old('terms') ? 'checked' : ''); ?> required
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const sendCodeUrl = <?php echo json_encode(route('customer.register.send-code'), 15, 512) ?>;
...
<?php /**PATH C:\Users\leanne\xampp\htdocs\InkWise-Web\ink-wise\resources\views/auth/customer/register.blade.php ENDPATH**/ ?>