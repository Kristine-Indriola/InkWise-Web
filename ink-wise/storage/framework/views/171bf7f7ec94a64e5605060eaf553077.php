...
<main class="admin-page-shell">
  ...
  <section class="orders-controls">
    <div class="summary-cards">
      ...
      <button type="button" class="summary-card-button" data-summary-filter="draft" data-summary-label="New Orders" data-summary-description="Fresh orders that need attention.">
        <div class="summary-card summary-card--highlight" data-summary-count="<?php echo e($draftCount); ?>">
      ...
      <button type="button" class="summary-card-button" data-summary-filter="ready_pickup" data-summary-label="Ready for pickup" data-summary-description="Orders packed and ready for customer pickup.">
        <div class="summary-card" data-summary-count="<?php echo e($confirmedCount); ?>">
          <div class="summary-card__label">Ready for pickup</div>
          <div class="summary-card__value"><?php echo e($confirmedCount); ?></div>
        </div>
      </button>
      ...
      <button type="button" class="summary-card-button" data-summary-filter="cancelled" data-summary-label="Cancelled" data-summary-description="Orders voided or cancelled by the team or customer.">
        <div class="summary-card" data-summary-count="<?php echo e($cancelledCount); ?>">
          <div class="summary-card__label">Cancelled</div>
          <div class="summary-card__value"><?php echo e($cancelledCount); ?></div>
        </div>
      </button>
    </div>
  ...
  <section class="card">
    <div class="card-body">
      <?php if($ordersCollection->isEmpty()): ?>
        <p>No orders found.</p>
      <?php else: ?>
        <div class="table-controls" style="display:flex; gap:12px; align-items:center; justify-content:space-between; margin-bottom:10px;">
          <div style="display:flex; gap:8px; align-items:center;">
            ...
            <form method="get" action="<?php echo e(route('admin.orders.index')); ?>" style="display:flex; gap:8px; align-items:center;">
              ...
              <input name="start_date" type="date" value="<?php echo e(request()->query('start_date')); ?>" aria-label="Start date" style="padding:6px 10px; border-radius:6px; border:1px solid #e5e7eb;">
              <label style="font-size:13px; color:#6b7280;">To</label>
              <input name="end_date" type="date" value="<?php echo e(request()->query('end_date')); ?>" aria-label="End date" style="padding:6px 10px; border-radius:6px; border:1px solid #e5e7eb;">
              <button type="submit" class="btn btn-sm" style="padding:6px 10px; border-radius:6px;">Filter</button>
              <a href="<?php echo e(route('admin.orders.index')); ?>" class="btn btn-sm" style="padding:6px 10px; border-radius:6px; background:#f3f4f6; margin-left:4px;">Clear</a>
            </form>
        ...
        <div class="table-responsive">
          <table class="table admin-orders-table" role="grid">
            ...
            <tbody>
              <?php $__currentLoopData = $ordersCollection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                  $rowStatus = strtolower($order->status ?? 'processing');
                ?>
                <tr data-order-id="<?php echo e($order->id); ?>" data-status="<?php echo e($rowStatus); ?>" data-order-url="<?php echo e(route('admin.ordersummary.show', ['order' => $order->id])); ?>" style="cursor: pointer;">
                  ...
                  <td class="text-center"><?php echo e((int) data_get($order, 'items_count', 0)); ?></td>
                  ...
                  <td>
                    ...
                    <span class="status-badge <?php echo e($statusClass); ?>">
                      <?php echo e($statusOptions[$orderStatus] ?? ucfirst(str_replace('_', ' ', $orderStatus))); ?>

                    </span>
                  </td>
                  <td><?php echo e(optional($order->order_date)->format('M j, Y') ?? optional($order->created_at)->format('M j, Y')); ?></td>
                  <td class="actions-cell">
                    <a href="<?php echo e(route('admin.ordersummary.show', ['order' => $order->id])); ?>" class="btn btn-outline btn-sm btn-icon" aria-label="View order <?php echo e($order->order_number ?? $order->id); ?>">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\leanne\xampp\htdocs\InkWise-Web\ink-wise\resources\views/admin/ordersummary/tables.blade.php ENDPATH**/ ?>