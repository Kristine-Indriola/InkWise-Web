...
<div class="page page1 active-page" data-page="0">
    <div class="templates-hero">
        <div>
            <?php if($showOnlyType === 'invitation'): ?>
            ...
            <?php elseif($showOnlyType === 'giveaway'): ?>
            ...
            <?php elseif($showOnlyType === 'envelope'): ?>
    ...
    <div class="templates-container">
        <?php if($showOnlyType): ?>
            ...
            ?>
            <section class="template-section" aria-labelledby="<?php echo e($showOnlyType); ?>-templates-heading">
                <div class="template-section-header">
                    <div>
                        <h3 id="<?php echo e($showOnlyType); ?>-templates-heading"><?php echo e($templateTypeLabel); ?> Templates</h3>
                        <p><?php echo e($templateDescription); ?></p>
                    </div>
                    <span class="template-count"><?php echo e($filteredTemplates->count()); ?> templates</span>
                </div>
                <?php if($filteredTemplates->isNotEmpty()): ?>
                    <div class="templates-grid">
                        <?php $__currentLoopData = $filteredTemplates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="template-card" tabindex="0" role="button" data-template-id="<?php echo e($template->id); ?>">
                                <div class="template-image-container">
                                    ...
                                    ?>
                                    <?php if($frontImg): ?>
                                        <img src="<?php echo \App\Support\ImageResolver::url($frontImg); ?>" alt="<?php echo e($template->name); ?>" class="template-img">
                                    <?php else: ?>
                                        <span>No preview</span>
                                    <?php endif; ?>
                                    <?php if($backImg): ?>
                                        <img src="<?php echo \App\Support\ImageResolver::url($backImg); ?>" alt="Back of <?php echo e($template->name); ?>" class="back-thumb">
                                    <?php endif; ?>
                                </div>
                                <div class="card-overlay">
                                    ...
                                    <div class="card-meta">
                                        <span class="meta-pill"><?php echo e($template->event_type ?? '—'); ?></span>
                                        <span class="meta-pill"><?php echo e($template->theme_style ?? '—'); ?></span>
                                    </div>
                                    <div class="card-actions">
                                        <button type="button" class="btn continue-btn"
                                            ...
                                            data-template-description="<?php echo e($template->description); ?>"
                                            data-template-event_type="<?php echo e($template->event_type); ?>"
                                            data-template-product_type="<?php echo e($template->product_type); ?>"
                                            data-template-theme_style="<?php echo e($template->theme_style); ?>"
                                            data-template-preview="<?php echo e($template->preview ? \App\Support\ImageResolver::url($template->preview) : ''); ?>"
                                            data-front-url="<?php echo e(($template->front_image ?? $template->preview) ? \App\Support\ImageResolver::url($template->front_image ?? $template->preview) : ''); ?>"
                                        >Use template</button>
                                        <button type="button" class="btn delete-btn template-reback-btn" data-reback-url="<?php echo e(route('admin.templates.reback', $template->id)); ?>" data-template-name="<?php echo e($template->name); ?>">Return</button>
                                        <?php if(!empty($template->front_image) || !empty($template->preview)): ?>
                                            <button type="button" class="btn view-front-btn" data-front-url="<?php echo e(($template->front_image ?? $template->preview) ? \App\Support\ImageResolver::url($template->front_image ?? $template->preview) : ''); ?>">View Front</button>
                                        <?php endif; ?>
                                        <?php if(!empty($template->back_image) || !empty($template->preview_back)): ?>
                                            <button type="button" class="btn view-back-btn" data-back-url="<?php echo e(($template->back_image ?? $template->preview_back) ? \App\Support\ImageResolver::url($template->back_image ?? $template->preview_back) : ''); ?>">View Back</button>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                ...
                <?php else: ?>
                    <div class="templates-empty">
                        <p>No <?php echo e($showOnlyType); ?> templates available yet. Create a new template to get started.</p>
                        <button type="button" class="btn-secondary" onclick="Navigation.showPage(1)">Create Custom <?php echo e(ucfirst($showOnlyType)); ?></button>
                    </div>
                <?php endif; ?>
            </section>
        <?php else: ?>
            ...
            <section class="template-section" aria-labelledby="invitation-templates-heading">
                <div class="template-section-header">
                    ...
                    <span class="template-count"><?php echo e($invitationTemplates->count()); ?> templates</span>
                </div>
                <?php if($invitationTemplates->isNotEmpty()): ?>
                    <div class="templates-grid">
                        <?php $__currentLoopData = $invitationTemplates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="template-card" tabindex="0" role="button" data-template-id="<?php echo e($template->id); ?>">
                                <div class="template-image-container">
                                    <?php
                                        $frontImg = $template->front_image ?? $template->preview_front ?? $template->preview;
            ...
            <section class="template-section" aria-labelledby="giveaway-templates-heading">
                <div class="template-section-header">
                    ...
                    <span class="template-count"><?php echo e($giveawayTemplates->count()); ?> templates</span>
                </div>
                <?php if($giveawayTemplates->isNotEmpty()): ?>
                    <div class="templates-grid">
                        <?php $__currentLoopData = $giveawayTemplates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="template-card" tabindex="0" role="button" data-template-id="<?php echo e($template->id); ?>">
                                <div class="template-image-container">
                                    <?php
                                        $frontImg = $template->front_image ?? $template->preview_front ?? $template->preview;
            ...
            <?php if($otherTemplates->isNotEmpty()): ?>
                <section class="template-section" aria-labelledby="other-templates-heading">
                    <div class="template-section-header">
                        ...
                        <span class="template-count"><?php echo e($otherTemplates->count()); ?> templates</span>
                    </div>
                    <div class="templates-grid">
                        <?php $__currentLoopData = $otherTemplates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="template-card" tabindex="0" role="button" data-template-id="<?php echo e($template->id); ?>">
                                <div class="template-image-container">
                                    <?php
                                        $frontImg = $template->front_image ?? $template->preview_front ?? $template->preview;
                                ...
                                <div class="card-overlay">
                                    ...
                                    <p><?php echo e($template->description); ?></p>
                                    <div class="card-meta">
                                        <span class="meta-pill"><?php echo e($template->product_type ?? '—'); ?></span>
                                        <span class="meta-pill"><?php echo e($template->theme_style ?? '—'); ?></span>
                                    </div>
                                    <div class="card-actions">
                                        <button type="button" class="btn continue-btn"
...
<?php /**PATH C:\Users\leanne\xampp\htdocs\InkWise-Web\ink-wise\resources\views/admin/products/templates.blade.php ENDPATH**/ ?>