...
<head>
  ...
  <title><?php echo $__env->yieldContent('title', 'Staff Dashboard'); ?></title>
...
<body>
  <div class="sidebar" id="sidebar" style="padding-top:32px;">
    ...
    <div class="profile" style="display:flex; flex-direction:column; align-items:center; justify-content:flex-start; margin-bottom:18px;">
      <img src="<?php echo e(asset('images/logo.png')); ?>" alt="InkWise Logo"
    ...
    <ul>
      <li class="<?php echo e(request()->routeIs('staff.dashboard') ? 'active' : ''); ?>">
        <a href="<?php echo e(route('staff.dashboard')); ?>"><i class="fi fi-sr-house-chimney"></i> <span class="label">Dashboard</span></a>
      </li>
      <li class="<?php echo e(request()->routeIs('staff.templates.*') ? 'active' : ''); ?>">
        <a href="<?php echo e(route('staff.templates.uploaded')); ?>"><i class="fa-solid fa-images"></i> <span class="label">Templates</span></a>
      </li>

      <li class="<?php echo e(request()->routeIs('staff.messages.*') ? 'active' : ''); ?>">
        <a href="<?php echo e(route('staff.messages.index')); ?>"><i class="fa-solid fa-envelope"></i> <span class="label">Messages</span></a>
      </li>
      <li class="<?php echo e(request()->routeIs('staff.reviews.*') ? 'active' : ''); ?>">
        <a href="<?php echo e(route('staff.reviews.index')); ?>">
          ...
          <?php if($unrepliedReviewsCount > 0): ?>
              <span class="notif-badge" style="position: relative; top: auto; right: auto; margin-left: 8px;"><?php echo e($unrepliedReviewsCount); ?></span>
          <?php endif; ?>
        </a>
      </li>
      <li class="<?php echo e(request()->routeIs('staff.order_list.index') ? 'active' : ''); ?>">
        <a href="<?php echo e(route('staff.order_list.index')); ?>"><i class="fa-solid fa-list"></i> <span class="label">Order List</span></a>
      </li>
      <li class="<?php echo e(request()->routeIs('staff.customer_profile') ? 'active' : ''); ?>">
        <a href="<?php echo e(route('staff.customer_profile')); ?>"><i class="fa-solid fa-users"></i> <span class="label">Customer Profiles</span></a>
      </li>


      <li class="<?php echo e(request()->routeIs('staff.materials.*') ? 'active' : ''); ?>">
        <a href="<?php echo e(route('staff.materials.index')); ?>"><i class="fa-solid fa-boxes-stacked"></i> <span class="label">Inventory</span></a>
      </li>
    </ul>
  </div>
  ...
  <div class="content-wrapper">
    <div class="topbar">
      ...
      <div class="icons" style="display: flex; align-items: center; gap: 24px; margin-left: auto; justify-content: center;">
        <a href="<?php echo e(route('staff.materials.notification')); ?>" class="nav-link notif-btn" style="display:flex; align-items:center; justify-content:center;">
        ...
        <a href="<?php echo e(route('staff.messages.index')); ?>" class="nav-link notif-btn" title="Messages" style="display:flex; align-items:center; justify-content:center;">
        ...
        <div class="profile-dropdown" style="position: relative; display:flex; align-items:center; gap:6px;">
          <a href="<?php echo e(route('staff.profile.edit')); ?>" id="profileImageLink" style="display:flex; align-items:center; text-decoration:none; color:inherit;">
            <?php
            ...
            <?php if($profilePicUrl): ?>
              <img src="<?php echo e($profilePicUrl); ?>" alt="Staff Profile" style="border-radius:50%; width:36px; height:36px; border:2px solid #6a2ebc; object-fit:cover;">
            <?php else: ?>
...
<?php /**PATH C:\Users\leanne\xampp\htdocs\InkWise-Web\ink-wise\resources\views/layouts/staffapp.blade.php ENDPATH**/ ?>