...
<?php $__env->startPush('scripts'); ?>
    <?php echo app('Illuminate\Foundation\Vite')('resources/js/admin/template/template.js'); ?>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.addEventListener('click', function(e) {
                ...
                if (e.target && e.target.classList.contains('remove-preview')) {
                    ...
                    fetch(`<?php echo e(url('staff/templates/preview')); ?>/${previewId}/remove`, {
                        method: 'POST',
                        headers: {
...
<?php $__env->startSection('content'); ?>
    ...
    <main class="dashboard-container templates-page" role="main">
        <section class="templates-container" aria-labelledby="templates-heading">
            <div class="templates-header">
                ...
                <div class="header-actions">
                    <a href="<?php echo e(route('staff.templates.uploaded')); ?>" class="btn-secondary">
                    ...
                    <div class="create-dropdown-container">
                        ...
                        <div class="create-dropdown-menu" role="menu" aria-hidden="true">
                            <a href="<?php echo e(route('staff.templates.create', ['type' => 'invitation'])); ?>" class="dropdown-item" role="menuitem">
                                <span class="item-icon">■</span>
                                <span>Invitation</span>
                            </a>
                            <a href="<?php echo e(route('staff.templates.create', ['type' => 'giveaway'])); ?>" class="dropdown-item" role="menuitem">
                                <span class="item-icon">●</span>
                                <span>Giveaway</span>
                            </a>
                            <a href="<?php echo e(route('staff.templates.create', ['type' => 'envelope'])); ?>" class="dropdown-item" role="menuitem">
                                <span class="item-icon">▬</span>
                                <span>Envelope</span>
                            </a>
                        </div>
            ...
            <div class="templates-filters">
                <div class="filter-buttons" role="group" aria-label="Filter templates">
                    <a href="<?php echo e(route('staff.templates.index')); ?>" class="filter-btn <?php echo e(!$type ?? true ? 'active' : ''); ?>" data-filter="all">
                        All
                    </a>
                    <a href="<?php echo e(route('staff.templates.index', ['type' => 'invitation'])); ?>" class="filter-btn <?php echo e($type === 'invitation' ? 'active' : ''); ?>" data-filter="invitation">
                        Invitations
                    </a>
                    <a href="<?php echo e(route('staff.templates.index', ['type' => 'giveaway'])); ?>" class="filter-btn <?php echo e($type === 'giveaway' ? 'active' : ''); ?>" data-filter="giveaway">
                        Giveaways
                    </a>
                    <a href="<?php echo e(route('staff.templates.index', ['type' => 'envelope'])); ?>" class="filter-btn <?php echo e($type === 'envelope' ? 'active' : ''); ?>" data-filter="envelope">
                        Envelopes
                    </a>
                </div>
            </div>
        ...
        <?php if(session('template_import_warnings')): ?>
            <?php
    ...
    <?php if((empty($previewTemplates) || count($previewTemplates) === 0) && $templates->isEmpty()): ?>
        ...
        <?php else: ?>
            <div class="templates-grid mt-gap" role="list">
                ...
                <?php if(isset($previewTemplates) && count($previewTemplates)): ?>
                    <?php $__currentLoopData = $previewTemplates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $preview): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <article class="template-card template-card--draft" role="listitem">
                            <span class="badge badge-draft">Draft</span>
                            <div class="template-preview">
                                <?php if(!empty($preview['front_image_path'])): ?>
                                    <img class="preview-clickable" src="<?php echo e(\App\Support\ImageResolver::url($preview['front_image_path'])); ?>" alt="Preview of <?php echo e($preview['name']); ?>" loading="lazy">
                                <?php elseif(!empty($preview['front_svg_content'])): ?>
                                    <div class="svg-preview-container" style="width:100%;height:200px;display:flex;align-items:center;justify-content:center;border:1px solid #d1d5db;background:#fff;">
                                        <?php echo $preview['front_svg_content']; ?>
                                ...
                                <?php endif; ?>
                                <?php if(!empty($preview['back_image_path'])): ?>
                                    <img class="back-thumb preview-clickable" src="<?php echo e(\App\Support\ImageResolver::url($preview['back_image_path'])); ?>" alt="Back of <?php echo e($preview['name']); ?>" loading="lazy">
                                <?php elseif(!empty($preview['back_svg_content'])): ?>
                                    <div class="svg-preview-container back-thumb" style="width:60px;height:60px;display:flex;align-items:center;justify-content:center;border:1px solid #d1d5db;background:#fff;position:absolute;bottom:8px;right:8px;">
                                        <?php echo $preview['back_svg_content']; ?>
                            ...
                            <div class="template-info">
                                <div class="template-meta">
                                    <span class="template-category"><?php echo e($preview['product_type'] ?? 'Uncategorized'); ?></span>
                                    <span class="template-date">Preview</span>
                                </div>
                                <h3 class="template-title"><?php echo e($preview['name']); ?></h3>
                                <?php if(!empty($preview['description'])): ?>
                                    <p class="template-description"><?php echo e($preview['description']); ?></p>
                                <?php endif; ?>
                            </div>
                            <div class="template-actions">
                                <div class="action-buttons">
                                    <a href="<?php echo e(route('staff.templates.create', ['type' => strtolower($preview['product_type'] ?? 'invitation'), 'edit_preview' => $preview['id']])); ?>" class="btn-action btn-edit" title="Edit Template Details">Edit</a>
                                    <button type="button" class="btn-action btn-upload upload-template-btn" 
                                            data-template-id="<?php echo e($preview['id']); ?>"
                                            data-template-name="<?php echo e($preview['name']); ?>"
                                            data-upload-url="<?php echo e(route('staff.templates.preview.save', ['preview' => $preview['id']])); ?>"
                                            title="Upload Template">
                                        Upload
                                    </button>
                                </div>
                                <form action="#" method="POST" class="delete-form remove-preview-form" data-preview-id="<?php echo e($preview['id']); ?>">
                                    <?php echo csrf_field(); ?>
                ...
                <?php $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <article class="template-card" role="listitem">
                        ...
                        ?>
                        <div class="<?php echo e($templatePreviewClasses); ?>">
                            <?php if($hasMultiplePreviews): ?>
                                <?php
                                ...
                                <div class="multiple-previews" role="list">
                                    <?php $__currentLoopData = $orderedPreviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $previewItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                            $isPrimary = $previewItem['key'] === 'front' || $loop->first;
                                        ?>
                                        <figure class="preview-item<?php echo e($isPrimary ? ' preview-item--primary' : ''); ?>" role="listitem" aria-label="<?php echo e($previewItem['label']); ?>">
                                            <img src="<?php echo e(\App\Support\ImageResolver::url($previewItem['path'])); ?>" alt="<?php echo e($previewItem['label']); ?>" loading="lazy">
                                            <figcaption class="preview-item__label"><?php echo e($previewItem['label']); ?></figcaption>
                                        </figure>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            <?php elseif($front): ?>
                                ...
                                <?php else: ?>
                                    <img class="preview-clickable" src="<?php echo e(\App\Support\ImageResolver::url($front)); ?>" alt="Preview of <?php echo e($template->name); ?>" loading="lazy">
                                <?php endif; ?>
                            <?php else: ?>
                                <?php if(!empty($template->design)): ?>
                                    <div class="preview-placeholder">
                                        <div class="placeholder-icon">
                            ...
                            <?php if($back): ?>
                                ...
                                <?php else: ?>
                                    <img class="back-thumb preview-clickable" src="<?php echo e(\App\Support\ImageResolver::url($back)); ?>" alt="Back of <?php echo e($template->name); ?>" loading="lazy" data-preview-img="<?php echo e(\App\Support\ImageResolver::url($back)); ?>">
                                <?php endif; ?>
                            <?php else: ?>
                                <div class="back-thumb back-placeholder" title="No back preview">
                                    <i class="fas fa-file-image"></i>
                        ...
                        <div class="template-info">
                            <div class="template-meta">
                                ...
                                <?php if($template->updated_at): ?>
                                    <span class="template-date"><?php echo e($template->updated_at->format('M d, Y')); ?></span>
                                <?php endif; ?>
                                <?php if($template->status === 'returned'): ?>
                            ...
                            <?php endif; ?>
                            <?php if($template->status === 'returned' && $template->status_note): ?>
                                    <div class="template-note">
                                        <strong>Admin Note:</strong> <?php echo e($template->status_note); ?>
                        ...
                        <div class="template-actions">
                            <div class="action-buttons">
                                <a href="<?php echo e(route('staff.templates.edit', $template->id)); ?>" class="btn-action btn-edit" title="Edit Template Details">
                                    Edit
                                </a>
                                <a href="<?php echo e(route('staff.templates.editor', $template->id)); ?>" class="btn-action btn-editor" title="Open in Editor">
                                    Editor
                                </a>
                                <button type="button" class="btn-action btn-upload upload-template-btn"
                                        data-template-id="<?php echo e($template->id); ?>"
                                        data-template-name="<?php echo e($template->name); ?>"
                                        data-upload-url="<?php echo e(route('staff.templates.uploadToProductUploads', $template->id)); ?>"
                                        data-url="<?php echo e(route('staff.templates.uploadToProductUploads', $template->id)); ?>"
                                        title="Upload Template">
                                    Upload
                                </button>
                            </div>
                            <form action="<?php echo e(route('staff.templates.destroy', $template->id)); ?>" method="POST" class="delete-form">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.staffapp', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\leanne\xampp\htdocs\InkWise-Web\ink-wise\resources\views/staff/templates/index.blade.php ENDPATH**/ ?>