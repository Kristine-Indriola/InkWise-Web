<?php $__env->startSection('title', 'Products Dashboard'); ?>
<link rel="stylesheet" href="<?php echo e(asset('css/admin-css/product.css')); ?>">
...
<main class="dashboard-container admin-page-shell" role="main" style="padding-left:140px;">
    ...
    <section class="summary-cards" aria-label="Product summary">
        <article class="summary-card">
            ...
            <span class="summary-card-value"><?php echo e(number_format($invitationCount ?? 0)); ?></span>
        </article>
        <article class="summary-card">
            <div class="summary-card-header">
            ...
            <span class="summary-card-value"><?php echo e(number_format($giveawayCount ?? 0)); ?></span>
        </article>
        <article class="summary-card">
            <div class="summary-card-header">
            ...
            <span class="summary-card-value"><?php echo e(number_format($envelopeCount ?? 0)); ?></span>
        </article>
        <article class="summary-card">
            <div class="summary-card-header">
            ...
            <span class="summary-card-value"><?php echo e(number_format($totalUploads ?? 0)); ?></span>
        </article>
        <article class="summary-card">
            <div class="summary-card-header">
            ...
            <span class="summary-card-value"><?php echo e(number_format($uploadedTemplatesCount ?? 0)); ?></span>
        </article>
    </section>
    ...
    <div class="search-and-add">
        <div class="filter-buttons" role="group" aria-label="Filter products by type">
            <a href="<?php echo e($filterBaseRoute); ?>" class="filter-btn <?php echo e($activeFilter === 'All' ? 'active' : ''); ?>" <?php if($activeFilter === 'All'): ?> aria-current="page" <?php endif; ?>>All</a>
            <a href="<?php echo e($invitationRoute); ?>" class="filter-btn <?php echo e($activeFilter === 'Invitation' ? 'active' : ''); ?>" <?php if($activeFilter === 'Invitation'): ?> aria-current="page" <?php endif; ?>>Invitations</a>
            <a href="<?php echo e($giveawayRoute); ?>" class="filter-btn <?php echo e($activeFilter === 'Giveaway' ? 'active' : ''); ?>" <?php if($activeFilter === 'Giveaway'): ?> aria-current="page" <?php endif; ?>>Giveaways</a>
            <a href="<?php echo e($envelopeRoute); ?>" class="filter-btn <?php echo e($activeFilter === 'Envelope' ? 'active' : ''); ?>" <?php if($activeFilter === 'Envelope'): ?> aria-current="page" <?php endif; ?>>Envelopes</a>
        </div>
        <div class="add-buttons">
            ...
            <a href="<?php echo e(route('admin.products.create.invitation')); ?>" class="btn-add-new" aria-label="Upload new product"><i class="fi fi-rr-cloud-upload"></i> Create New Product</a>
            <a href="<?php echo e(route('admin.products.create.giveaway')); ?>" class="btn-add-new" aria-label="Create new giveaway"><i class="fi fi-rr-gift"></i> Create Giveaway</a>
            <a href="<?php echo e(route('admin.products.create.envelope')); ?>" class="btn-add-new" aria-label="Create new envelope"><i class="fi-sr-envelope"></i> Create Envelope</a>
        </div>
    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\leanne\xampp\htdocs\InkWise-Web\ink-wise\resources\views/admin/products/index.blade.php ENDPATH**/ ?>