<?php $__env->startSection('title', 'Inventory Analytics'); ?>
...
<main class="reports-shell admin-page-shell" id="adminInventoryReportsShell">
	...
	<section class="report-header-section" aria-label="Report header">
		<div class="report-header-content">
			...
			<div class="report-meta-info">
				<div class="meta-item">
					<strong>Date Generated:</strong> <?php echo e($reportDate); ?>

				</div>
				<div class="meta-item">
					<strong>Reporting Period:</strong> <?php echo e($reportPeriod); ?>
				...
				<div class="meta-item">
					<strong>Total Items:</strong> <?php echo e(number_format($materialSnapshots->count())); ?>
	...
	<header class="page-header reports-page-header">
		...
		<div class="page-header__actions">
			<nav class="page-nav" aria-label="Quick navigation">
				<a href="<?php echo e(route('admin.reports.sales')); ?>" class="pill-link" aria-label="View sales analytics">
					<i class="fi fi-rr-chart-histogram" aria-hidden="true"></i>
					<span>Sales Analytics</span>
				</a>
				<a href="<?php echo e(route('admin.reports.pickup-calendar')); ?>" class="pill-link" aria-label="View pickup calendar">
	...
	<section class="reports-filter-bar" aria-label="Filter inventory data by date range">
		<form method="GET" class="reports-filter-form" role="search">
			...
			<div class="reports-filter-actions">
				...
				<?php if($currentFilters['startDate'] || $currentFilters['endDate']): ?>
					<a href="<?php echo e(route('admin.reports.inventory')); ?>" class="pill-link" aria-label="Clear all filters">
	...
	<section class="reports-summary-grid" aria-label="Key inventory metrics overview">
		<article class="reports-summary-card" aria-labelledby="total-skus-heading">
			...
			<strong data-metric="total-skus"><?php echo e(number_format($inventoryStats['totalSkus'] ?? $reportPayload['totalTracked'] ?? 0)); ?></strong>
		...
		<article class="reports-summary-card" aria-labelledby="total-units-heading">
			...
			<strong data-metric="total-stock"><?php echo e(number_format($inventoryStats['totalStock'] ?? 0)); ?></strong>
		...
		<article class="reports-summary-card" aria-labelledby="stock-value-heading">
			...
			<strong>₱<?php echo e(number_format($totalStockValue, 2)); ?></strong>
		...
		<article class="reports-summary-card" aria-labelledby="low-stock-heading">
			...
			<strong data-metric="low-stock"><?php echo e(number_format($inventoryStats['lowStock'] ?? ($reportPayload['statusBreakdown']['low'] ?? 0))); ?></strong>
		...
		<article class="reports-summary-card" aria-labelledby="out-stock-heading">
			...
			<strong data-metric="out-stock"><?php echo e(number_format($inventoryStats['outStock'] ?? ($reportPayload['statusBreakdown']['out-of-stock'] ?? 0))); ?></strong>
	...
	<section class="reports-summary-grid value-summary-section" aria-label="Inventory value summary">
		...
		<article class="reports-summary-card value-card">
			...
			<strong>₱<?php echo e($materialSnapshots->count() > 0 ? number_format($totalStockValue / $materialSnapshots->count(), 2) : '0.00'); ?></strong>
		...
		<article class="reports-summary-card value-card">
			...
			<strong><?php echo e($inventoryTurnover); ?>%</strong>
	...
	<section class="reports-panel analysis-section" aria-label="Inventory analysis and insights">
		...
		<div class="analysis-grid">
			<div class="analysis-card">
				...
				<p class="analysis-count"><?php echo e($fastMovingItems->count()); ?> items</p>
				<p class="analysis-description">High turnover items that need frequent restocking</p>
				<?php if($fastMovingItems->isNotEmpty()): ?>
					<ul class="analysis-list">
						<?php $__currentLoopData = $fastMovingItems->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<li><?php echo e($item['model']->material_name); ?> (<?php echo e(number_format($item['stock_out'])); ?> units moved)</li>
			...
			<div class="analysis-card">
				...
				<p class="analysis-count"><?php echo e($slowMovingItems->count()); ?> items</p>
				<p class="analysis-description">Items with minimal movement that may need review</p>
				<?php if($slowMovingItems->isNotEmpty()): ?>
					<ul class="analysis-list">
						<?php $__currentLoopData = $slowMovingItems->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<li><?php echo e($item['model']->material_name); ?> (<?php echo e(number_format($item['stock_out'])); ?> units moved)</li>
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					</ul>
				<?php endif; ?>
			...
			<div class="analysis-card">
				...
				<p class="analysis-count"><?php echo e($overstockedItems->count()); ?> items</p>
				<p class="analysis-description">Items with excess quantities tying up capital</p>
				<?php if($overstockedItems->isNotEmpty()): ?>
					<ul class="analysis-list">
						<?php $__currentLoopData = $overstockedItems->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<li><?php echo e($item['model']->material_name); ?> (<?php echo e(number_format($item['stock'])); ?> units in stock)</li>
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					</ul>
				<?php endif; ?>
			</div>
			<div class="analysis-card alert-card">
				...
				<p class="analysis-count"><?php echo e($outOfStockItems->count() + $lowStockItems->count()); ?> items</p>
				<p class="analysis-description">Items requiring immediate attention</p>
				<?php if($hotList->isNotEmpty()): ?>
					<ul class="analysis-list">
						<?php $__currentLoopData = $hotList->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<li class="<?php echo e($item['status_key'] === 'out-of-stock' ? 'critical' : 'warning'); ?>">
								<?php echo e($item['model']->material_name); ?> - <?php echo e($item['status']); ?>
			...
			<div class="analysis-card">
				...
				<p class="analysis-count"><?php echo e($recentlyRestocked->count()); ?> items</p>
				<p class="analysis-description">Items recently added to inventory</p>
				<?php if($recentlyRestocked->isNotEmpty()): ?>
					<ul class="analysis-list">
						<?php $__currentLoopData = $recentlyRestocked; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<li><?php echo e($item['model']->material_name); ?> (+<?php echo e(number_format($item['stock_in'])); ?> <?php echo e($item['unit_label']); ?>)</li>
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					</ul>
				<?php endif; ?>
			</div>
			<div class="analysis-card">
				<h3>📤 Recently Used</h3>
				<p class="analysis-count"><?php echo e($recentlyUsed->count()); ?> items</p>
				<p class="analysis-description">Items recently consumed or sold</p>
				<?php if($recentlyUsed->isNotEmpty()): ?>
					<ul class="analysis-list">
						<?php $__currentLoopData = $recentlyUsed; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<li><?php echo e($item['model']->material_name); ?> (-<?php echo e(number_format($item['stock_out'])); ?> <?php echo e($item['unit_label']); ?>)</li>
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					</ul>
				<?php endif; ?>
			</div>
	...
	<?php if($hotList->isNotEmpty()): ?>
		<section class="reports-panel reports-panel--attention" aria-labelledby="attention-heading">
			...
			<ul class="reports-callout-list">
				<?php $__currentLoopData = $hotList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $snapshot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<li data-status="<?php echo e($snapshot['status_key']); ?>">
						<div class="callout-title">
							<strong><?php echo e($snapshot['model']->material_name); ?></strong>
							<span class="status-pill status-pill--<?php echo e($snapshot['status_key']); ?>"><?php echo e($snapshot['status']); ?></span>
						</div>
						<div class="callout-meta">
							<span><strong>On hand:</strong> <?php echo e(number_format($snapshot['stock'])); ?></span>
							<span><strong>Reorder point:</strong> <?php echo e(number_format($snapshot['reorder'])); ?></span>
							<span><strong>Status:</strong> <?php echo e($snapshot['coverage_label']); ?> &middot; <?php echo e($snapshot['action']); ?></span>
						</div>
					</li>
				<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
			</ul>
		...
		<article class="reports-card" aria-label="Detailed inventory status table">
			<header>
				...
				<div class="reports-toolbar reports-toolbar--filters" role="group" aria-label="Inventory status filters">
					<button type="button" class="pill-link is-active" data-stock-filter="all" aria-pressed="true">
						<span>All Items</span>
						<span class="filter-count">(<?php echo e(number_format($totalTracked)); ?>)</span>
					</button>
					<button type="button" class="pill-link" data-stock-filter="in-stock" aria-pressed="false">
						<span>Healthy Stock</span>
						<span class="filter-count">(<?php echo e(number_format($inStockCount)); ?>)</span>
					</button>
					<button type="button" class="pill-link" data-stock-filter="low" aria-pressed="false">
						<span>Low Stock</span>
						<span class="filter-count">(<?php echo e(number_format($lowCount)); ?>)</span>
					</button>
					<button type="button" class="pill-link" data-stock-filter="out-of-stock" aria-pressed="false">
						<span>Out of Stock</span>
						<span class="filter-count">(<?php echo e(number_format($outCount)); ?>)</span>
					</button>
				</div>
			</header>
			<div class="table-wrapper">
				<table class="reports-table" id="inventoryTable">
					...
					<tbody>
					<?php $__empty_1 = true; $__currentLoopData = $materialSnapshots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $snapshot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
						<?php
						...
						?>
						<tr data-stock-status="<?php echo e($snapshot['status_key']); ?>" class="<?php echo e($rowClass); ?>">
							<td><?php echo e($material->material_name); ?></td>
							<td><?php echo e($categoryDisplay); ?></td>
							<td><?php echo e($unitLabel); ?></td>
							<td class="text-center"><?php echo e(number_format($snapshot['reorder'])); ?></td>
							<td class="text-center"><?php echo e($beginningDisplay); ?></td>
							<td class="text-center"><?php echo e($stockInDisplay); ?></td>
							<td class="text-center"><?php echo e($stockOutDisplay); ?></td>
							<td class="text-center"><?php echo e($endingDisplay); ?></td>
							<td class="text-end">₱<?php echo e(number_format($snapshot['unit_cost'], 2)); ?></td>
							<td class="text-end">₱<?php echo e(number_format($snapshot['stock_value'], 2)); ?></td>
							<td class="text-center"><?php echo e($snapshot['last_movement_date'] ?? 'N/A'); ?></td>
							<td><span class="<?php echo e($statusClass); ?>"><?php echo e($snapshot['status']); ?></span></td>
						</tr>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\leanne\xampp\htdocs\InkWise-Web\ink-wise\resources\views/admin/reports/inventory.blade.php ENDPATH**/ ?>