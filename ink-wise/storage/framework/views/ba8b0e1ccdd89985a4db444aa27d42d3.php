...
<?php $__env->startSection('title', 'Birthday Giveaways'); ?>
            ...
            <?php else: ?>
                <div class="giveaway-grid" role="list">
                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <article class="giveaway-card" role="listitem" data-product-id="<?php echo e($product->id); ?>">
                            <button type="button"
                            ...
                            <img src="<?php echo e($previewSrc); ?>"
                                 alt="<?php echo e($product->name); ?> giveaway preview"
                            ...
                            <div class="giveaway-card__info preview-trigger"
                                 ...
                                 role="button"
                                 tabindex="0">
                                <h3 class="giveaway-card__name"><?php echo e(\Illuminate\Support\Str::limit($product->name, 28)); ?></h3>
...
<?php echo $__env->make('customer.Invitations.invitations', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\leanne\xampp\htdocs\InkWise-Web\ink-wise\resources\views/customer/Giveaways/birthdaygive.blade.php ENDPATH**/ ?>