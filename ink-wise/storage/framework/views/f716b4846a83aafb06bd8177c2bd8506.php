...
<?php $__env->startSection('title', 'Corporate Invitations'); ?>
        ...
        <div class="layout-container">
            <div class="corporate-grid" role="list">
                <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    ?>
                    <article class="corporate-card" role="listitem" data-product-id="<?php echo e($product->id); ?>">
                        <button type="button"
                        ...
                        <img src="<?php echo e($previewSrc); ?>"
                             alt="<?php echo e($product->name); ?> corporate invitation"
                        ...
                        <div class="corporate-card__info preview-trigger"
                             ...
                             role="button"
                             tabindex="0">
                            <h3 class="corporate-card__name"><?php echo e(\Illuminate\Support\Str::limit($product->name, 28)); ?></h3>
...
<?php echo $__env->make('customer.Invitations.invitations', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\leanne\xampp\htdocs\InkWise-Web\ink-wise\resources\views/customer/Invitations/corporateinvite.blade.php ENDPATH**/ ?>