...
<section id="templates" class="py-12 relative overflow-hidden section-base">
  ...
  <div class="layout-container relative z-10">
    ...
    <div class="relative flex items-center gap-8 gradient-pink p-6 rounded-3xl">
      <img src="<?php echo e(asset('Customerimages/image/Star.png')); ?>" class="absolute -top-6 -left-8 w-12 h-12 rotate-12" alt="">
      <img src="<?php echo e(asset('Customerimages/image/Gift.png')); ?>" class="absolute -bottom-6 right-10 w-12 h-12" alt="">

      
      <a href="<?php echo e(route('templates.birthday.invitations')); ?>" class="block w-80 -rotate-3 rounded-3xl shadow-xl overflow-hidden border-4 border-pink-300 cursor-pointer hover:scale-105 transition-transform">
        <img src="<?php echo e(asset('Customerimages/image/birthday.png')); ?>" alt="Birthday" class="w-full h-40 object-cover">
      </a>
    ...
    <div class="relative flex items-center gap-8 gradient-yellow p-6 rounded-3xl flex-row-reverse">
      <img src="<?php echo e(asset('Customerimages/image/Ring.png')); ?>" class="absolute -top-6 -right-8 w-20 h-20 rotate-12 z-20" alt="">
      <img src="<?php echo e(asset('Customerimages/image/Ribbon.png')); ?>" class="absolute -bottom-6 left-10 w-12 h-12 rotate-12" alt="">

      <a href="<?php echo e(route('templates.wedding.invitations')); ?>" class="block w-80 rotate-3 rounded-3xl shadow-xl overflow-hidden border-4 border-yellow-400 cursor-pointer hover:scale-105 transition-transform">
        <img src="<?php echo e(asset('Customerimages/image/wedding.png')); ?>" alt="Wedding" class="w-full h-40 object-cover">
      </a>
    ...
    <div class="relative flex items-center gap-8 gradient-orange p-6 rounded-3xl">
      <img src="<?php echo e(asset('Customerimages/image/Glass.png')); ?>" class="absolute -top-6 -left-8 w-20 h-20 rotate-12 z-20" alt="">
      <img src="<?php echo e(asset('Customerimages/image/Paperclip.png')); ?>" class="absolute -bottom-6 left-44 w-12 h-12 rotate-12 z-20" alt="">

      <a href="<?php echo e(route('templates.corporate.invitations')); ?>" class="block w-80 -rotate-2 rounded-3xl shadow-xl overflow-hidden border-4 border-orange-400 cursor-pointer hover:scale-105 transition-transform">
        <img src="<?php echo e(asset('Customerimages/image/corporate.png')); ?>" alt="Corporate" class="w-full h-40 object-cover">
      </a>
    ...
    <div class="relative flex items-center gap-8 gradient-skyblue p-6 rounded-3xl flex-row-reverse">
      <img src="<?php echo e(asset('Customerimages/image/footprint.png')); ?>" class="absolute -top-6 -right-8 w-20 h-20 rotate-12 z-20" alt="">
      <img src="<?php echo e(asset('Customerimages/image/Cloud.png')); ?>" class="absolute -bottom-8 left-32 w-12 h-12 rotate-12" alt="">

      <a href="<?php echo e(route('templates.baptism.invitations')); ?>" class="block w-80 rotate-3 rounded-3xl shadow-xl overflow-hidden border-4 border-blue-400 cursor-pointer hover:scale-105 transition-transform">
        <img src="<?php echo e(asset('Customerimages/image/baptism.png')); ?>" alt="Baptism" class="w-full h-40 object-cover">
      </a>
...
<?php /**PATH C:\Users\leanne\xampp\htdocs\InkWise-Web\ink-wise\resources\views/customer/partials/templates.blade.php ENDPATH**/ ?>