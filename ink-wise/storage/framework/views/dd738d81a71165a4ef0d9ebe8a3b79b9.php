...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Inkwise Invitations'); ?></title>
                    ...
                    <ul class="flex items-center gap-4 text-sm font-semibold text-gray-700">
                        ...
                        <li class="relative">
                            ...
                            <div id="categoryMenu" class="absolute left-0 right-auto mt-2 hidden w-56 rounded-2xl border border-[#dbeafe] bg-white/95 backdrop-blur shadow-2xl lg:right-0">
                                <ul>
                                    <?php $__currentLoopData = $categoryLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
...
<?php /**PATH C:\Users\leanne\xampp\htdocs\InkWise-Web\ink-wise\resources\views/customer/Invitations/invitations.blade.php ENDPATH**/ ?>