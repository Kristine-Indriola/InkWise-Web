<?php $__env->startPush('styles'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/staff-css/notifications.css')); ?>">
<?php $__env->stopPush(); ?>

<?php $__env->startSection('title', 'Stock Notifications'); ?>
...
<main class="materials-page admin-page-shell notifications-page" role="main">
    <header class="page-header">
        ...
        <div class="page-header__quick-actions">
            <a href="<?php echo e(route('staff.materials.index')); ?>" class="pill-link is-active" aria-label="Back to materials list">
            ...
            <?php if($lowStock->count()): ?>
                <div class="notification-table" role="region" aria-live="polite">
                    <table>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $lowStock; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $material): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($material->material_name); ?></td>
                                    <td><?php echo e($material->material_type); ?></td>
                                    <td><span class="inventory-chip inventory-chip--warning"><?php echo e($material->inventory->stock_level); ?></span></td>
                                    <td><?php echo e($material->inventory->reorder_level); ?></td>
                                    <td class="text-end">
            ...
            <?php if($outOfStock->count()): ?>
                <div class="notification-table" role="region" aria-live="polite">
                    <table>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $outOfStock; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $material): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($material->material_name); ?></td>
                                    <td><?php echo e($material->material_type); ?></td>
                                    <td><span class="inventory-chip inventory-chip--danger"><?php echo e($material->inventory->stock_level); ?></span></td>
                                    <td><?php echo e($material->inventory->reorder_level); ?></td>
                                    <td class="text-end">
...
<?php echo $__env->make('layouts.staffapp', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\leanne\xampp\htdocs\InkWise-Web\ink-wise\resources\views/staff/materials/notification.blade.php ENDPATH**/ ?>