    ...
    <div class="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center gap-3 lg:gap-6 ml-8 sm:ml-16 lg:ml-36">
                ...
                <ul class="flex items-center gap-4 text-sm font-semibold text-gray-700">
                    <li>
                        <a href="<?php echo e(route('dashboard')); ?>"
                           class="inline-flex items-center gap-2 rounded-full px-4 py-2 transition <?php echo e(request()->routeIs('dashboard') ? 'bg-[#eef2ff] text-[#4338ca] shadow-sm' : 'hover:text-[#4338ca]'); ?>"
                           aria-current="<?php echo e(request()->routeIs('dashboard') ? 'page' : 'false'); ?>">
                            Home
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e($currentEventRoutes['invitations']); ?>"
                           class="inline-flex items-center gap-2 rounded-full px-4 py-2 transition <?php echo e(request()->routeIs('templates.' . $currentEventKey . '.invitations') ? 'bg-[#eef2ff] text-[#4338ca] shadow-sm' : 'hover:text-[#4338ca]'); ?>"
                           aria-current="<?php echo e(request()->routeIs('templates.' . $currentEventKey . '.invitations') ? 'page' : 'false'); ?>">
                            Invitations
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e($currentEventRoutes['giveaways']); ?>"
                           class="inline-flex items-center gap-2 rounded-full px-4 py-2 transition <?php echo e(request()->routeIs('templates.' . $currentEventKey . '.giveaways') ? 'bg-[#eef2ff] text-[#4338ca] shadow-sm' : 'hover:text-[#4338ca]'); ?>"
                           aria-current="<?php echo e(request()->routeIs('templates.' . $currentEventKey . '.giveaways') ? 'page' : 'false'); ?>">
                            Giveaways
                        </a>
                    </li>
                    <li class="relative">
                        <button id="categoryToggle" type="button" aria-haspopup="true" aria-expanded="false"
                            ...
                            <?php echo e($resolvedInvitationType); ?>
                        ...
                        <div id="categoryMenu" class="absolute left-0 right-auto mt-2 hidden w-56 rounded-2xl border border-[#dbeafe] bg-white/95 backdrop-blur shadow-2xl lg:right-0">
                            <ul>
                                <?php $__currentLoopData = $navLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li>
            ...
            <div class="flex items-center gap-3">
                <form action="<?php echo e(url('/search')); ?>" method="GET" class="hidden lg:flex ml-10">
                    <label for="desktop-invitation-search" class="sr-only">Search templates</label>
                    <input id="desktop-invitation-search" type="text" name="query" value="<?php echo e($searchValue); ?>" placeholder="Search templates..."
                ...
                <div class="hidden items-center gap-2 lg:flex ml-6">
                    <a href="<?php echo e($favoritesEnabled ? route('customer.favorites') : '#'); ?>"
                       class="nav-icon-button"
                       aria-label="My favorites"
                       title="My favorites"
                       <?php if (! ($favoritesEnabled)): ?> aria-disabled="true" <?php endif; ?>>
                        <i class="fi fi-br-comment-heart" aria-hidden="true"></i>
                    </a>
                    <a href="<?php echo e($cartRoute); ?>"
                       class="nav-icon-button"
                       aria-label="My cart"
                       title="My cart">
    ...
    <div id="mobileNavPanel" class="mx-auto hidden w-full max-w-7xl border-t border-[#e0e7ff] bg-white px-4 pb-6 pt-4 shadow-inner lg:hidden">
        <div class="space-y-5">
            <form action="<?php echo e(url('/search')); ?>" method="GET">
                ...
                <input id="mobile-invitation-search" type="text" name="query" value="<?php echo e($searchValue); ?>" placeholder="Search templates..."
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="<?php echo e($cartRoute); ?>" class="nav-icon-button" aria-label="My cart" title="My cart">
                    <i class="bi bi-bag-heart-fill" aria-hidden="true"></i>
                </a>
            </div>
            ...
            <ul class="space-y-2 text-sm font-semibold text-gray-700">
                <li>
                    <a href="<?php echo e(route('dashboard')); ?>"
                       class="flex items-center justify-between rounded-lg px-4 py-2 <?php echo e(request()->routeIs('dashboard') ? 'bg-[#eef2ff] text-[#4338ca]' : 'hover:bg-[#eef2ff] hover:text-[#4338ca]'); ?>"
                       aria-current="<?php echo e(request()->routeIs('dashboard') ? 'page' : 'false'); ?>">
                        <span>Home</span>
                ...
                <li>
                    <a href="<?php echo e($currentEventRoutes['invitations']); ?>"
                       class="flex items-center justify-between rounded-lg px-4 py-2 <?php echo e(request()->routeIs('templates.' . $currentEventKey . '.invitations') ? 'bg-[#eef2ff] text-[#4338ca]' : 'hover:bg-[#eef2ff] hover:text-[#4338ca]'); ?>"
                       aria-current="<?php echo e(request()->routeIs('templates.' . $currentEventKey . '.invitations') ? 'page' : 'false'); ?>">
                        <span>Invitations</span>
                        <?php if(request()->routeIs('templates.' . $currentEventKey . '.invitations')): ?>
                            <i class="bi bi-dot text-2xl"></i>
                        <?php endif; ?>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e($currentEventRoutes['giveaways']); ?>"
                       class="flex items-center justify-between rounded-lg px-4 py-2 <?php echo e(request()->routeIs('templates.' . $currentEventKey . '.giveaways') ? 'bg-[#eef2ff] text-[#4338ca]' : 'hover:bg-[#eef2ff] hover:text-[#4338ca]'); ?>"
                       aria-current="<?php echo e(request()->routeIs('templates.' . $currentEventKey . '.giveaways') ? 'page' : 'false'); ?>">
                        <span>Giveaways</span>
                        <?php if(request()->routeIs('templates.' . $currentEventKey . '.giveaways')): ?>
                            <i class="bi bi-dot text-2xl"></i>
                        <?php endif; ?>
                    </a>
                </li>
...
<?php /**PATH C:\Users\leanne\xampp\htdocs\InkWise-Web\ink-wise\resources\views/partials/topbar.blade.php ENDPATH**/ ?>