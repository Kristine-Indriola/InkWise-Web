<?php echo $__env->make('customer.studio._head', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<body>
<?php
...
<header class="studio-topbar">
    <div class="topbar-left">
        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="InkWise" class="topbar-logo">
        <div class="topbar-project">
            <span class="topbar-project-link">My Projects</span>
            <span class="topbar-divider">&ndash;</span>
            <span class="topbar-project-name"><?php echo e($product->name ?? $templateModel?->name ?? 'Save the Date Cards'); ?></span>
        </div>
    </div>
    ...
    <div class="topbar-actions">
        <button class="topbar-action-btn" type="button" onclick="window.location.href='<?php echo e(route('templates.wedding.invitations')); ?>'">Change Template</button>
        ...
        <button
            ...
            data-destination="<?php echo e(route('order.review')); ?>"
        >Next</button>
    </div>
</header>
    ...
    <section class="studio-canvas-area">
        <div class="canvas-workspace">
            ...
            <div class="canvas-stage">
                ...
                <div
                    ...
                    <?php if($canvasWidthAttr !== null): ?> data-canvas-width="<?php echo e($canvasWidthAttr); ?>" <?php endif; ?>
                    <?php if($canvasHeightAttr !== null): ?> data-canvas-height="<?php echo e($canvasHeightAttr); ?>" <?php endif; ?>
                    <?php if($canvasShapeAttr): ?> data-canvas-shape="<?php echo e($canvasShapeAttr); ?>" <?php endif; ?>
                    <?php if($canvasUnitAttr): ?> data-canvas-unit="<?php echo e($canvasUnitAttr); ?>" <?php endif; ?>
                >
                    <div
                        class="preview-card-bg"
                        data-has-back="<?php echo e($hasBackSide ? 'true' : 'false'); ?>"
                        data-front-image="<?php echo e($frontImage); ?>"
                        <?php if($hasBackSide && $backImage): ?>
                        data-back-image="<?php echo e($backImage); ?>"
                        <?php endif; ?>
                        <?php if($frontSvg): ?>
                        data-front-svg="<?php echo e($frontSvg); ?>"
                        <?php endif; ?>
                        <?php if($hasBackSide && $backSvg): ?>
                        data-back-svg="<?php echo e($backSvg); ?>"
                        <?php endif; ?>
                        style="background-image: url('<?php echo e($frontImage); ?>');"
                        <?php if($canvasWidthAttr !== null): ?> data-canvas-width="<?php echo e($canvasWidthAttr); ?>" <?php endif; ?>
                        <?php if($canvasHeightAttr !== null): ?> data-canvas-height="<?php echo e($canvasHeightAttr); ?>" <?php endif; ?>
                        <?php if($canvasShapeAttr): ?> data-canvas-shape="<?php echo e($canvasShapeAttr); ?>" <?php endif; ?>
                        <?php if($canvasUnitAttr): ?> data-canvas-unit="<?php echo e($canvasUnitAttr); ?>" <?php endif; ?>
                    >
                        <svg
                            ...
                            width="100%"
                            height="100%"
                            <?php if($canvasWidthAttr && $canvasHeightAttr): ?>
                                viewBox="0 0 <?php echo e($canvasWidthAttr); ?> <?php echo e($canvasHeightAttr); ?>"
                            <?php else: ?>
                                viewBox="0 0 433 559"
                            <?php endif; ?>
        ...
        <div class="preview-thumbs" role="tablist" aria-label="Card sides">
            <button type="button" class="preview-thumb active" data-card-thumb="front" aria-pressed="true">
                <div class="thumb-preview" <?php if($frontImage): ?> style="background-image: url('<?php echo e($frontImage); ?>');" <?php endif; ?>>
            ...
            <button type="button" class="preview-thumb" data-card-thumb="back" aria-pressed="false">
                <div class="thumb-preview" <?php if($backImage): ?> style="background-image: url('<?php echo e($backImage); ?>');" <?php endif; ?>>
...
<?php echo $__env->make('customer.studio._bootstrap', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php /**PATH C:\Users\leanne\xampp\htdocs\InkWise-Web\ink-wise\resources\views/customer/order/studio.blade.php ENDPATH**/ ?>