...
<body class="finalstep-body bg-white" data-product-id="<?php echo e($product->id ?? ''); ?>">
<?php
			...
			<div class="base-price-content">
				<div class="base-price-header">
					...
					<div class="base-price-amount">
						...
						<span class="price-value"><?php echo e($formatMoney($basePricePerPiece)); ?></span>
					</div>
				</div>
...
<?php /**PATH C:\xampp\htdocs\InkWise-Web\ink-wise\resources\views/customer/orderflow/finalstep.blade.php ENDPATH**/ ?>