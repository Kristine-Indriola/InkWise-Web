...
<main class="order-status-shell">
    ...
    <section class="order-status-card">
        <header class="order-status-card__header">
            ...
            <span class="order-stage-chip order-stage-chip--<?php echo e($currentChipModifier); ?>">
                <?php echo e($formatStatusLabel($currentStatus)); ?>
        ...
        <div class="order-status-meta">
            <div class="order-status-meta__item">
                ...
                <span class="order-status-meta__value"><?php echo e($orderNumber); ?></span>
            </div>
            <div class="order-status-meta__item">
            ...
            <div class="order-status-meta__item">
                ...
                <span class="order-status-meta__value"><?php echo e($placedDateDisplay ?? 'Not available'); ?></span>
            </div>
            <div class="order-status-meta__item">
    ...
    <section class="status-progress-card">
        ...
        <ol class="status-tracker" aria-label="Order progress">
            <?php $__currentLoopData = $statusFlow; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $statusKey): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                ?>
                <li class="status-tracker__item <?php echo e($stateClass); ?>">
                    ...
                    <div class="status-tracker__content">
                        <p class="status-tracker__title">
                            <?php echo e($formatStatusLabel($statusKey)); ?>
    ...
    <?php if($currentStatus !== 'cancelled'): ?>
    <form method="POST" action="<?php echo e(route('admin.orders.status.update', $order)); ?>" class="status-form-card status-form">
        <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <select id="status" name="status" required>
                    <?php $__currentLoopData = $statusOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($value); ?>" <?php echo e($currentStatus === $value ? 'selected' : ''); ?>>
                            <?php echo e($label); ?>
...
<script>
    (function () {
        ...
        const payload = {
            ...
            status: <?php echo json_encode($currentStatus, 15, 512) ?>,
            statusLabel: <?php echo json_encode($currentStatusLabel, 15, 512) ?>,
            consumedBy: []
        };
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\leanne\xampp\htdocs\InkWise-Web\ink-wise\resources\views/admin/orders/manage-status.blade.php ENDPATH**/ ?>