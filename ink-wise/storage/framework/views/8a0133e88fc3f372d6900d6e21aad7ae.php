<?php $__env->startSection('title', 'Create Giveaway Product'); ?>
...
<form method="POST" action="<?php echo e(route('admin.products.store')); ?>" id="giveaway-form" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <?php if($isEditing): ?>
                ...
                <div class="responsive-grid grid-2-cols">
                    <div class="field">
                        ...
                        <input type="text"
                               ...
                               value="<?php echo e($defaults['name']); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="field">
                        ...
                        <select id="eventType" name="eventType" required aria-required="true" aria-describedby="eventType-error">
                            ...
                            <?php $__currentLoopData = ['Wedding', 'Birthday', 'Baptism', 'Corporate', 'Debut', 'Holiday']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="responsive-grid grid-2-cols">
                    ...
                    <div class="field">
                        ...
                        <select id="envelope_material_id"
                            ...
                            <option value="" disabled <?php echo e($materialDefaults['material_id'] ? '' : 'selected'); ?>>Select Souvenirs Material</option>
                            <?php $__currentLoopData = $materialOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $material): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($material->material_id); ?>"
                                        data-material-type="<?php echo e($material->material_type); ?>"
                                        data-unit-cost="<?php echo e($material->unit_cost ?? ''); ?>"
                                    <?php echo e((string) $materialDefaults['material_id'] === (string) $material->material_id ? 'selected' : ''); ?>>
                ...
                <div class="responsive-grid grid-2-cols">
                    <div class="field">
                        ...
                        <input type="number"
                               ...
                               value="<?php echo e($defaults['base_price']); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="field">
                        ...
                        <input type="text"
                               ...
                               value="<?php echo e($defaults['lead_time']); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="field">
                    ...
                    <input type="date"
                           ...
                           value="<?php echo e($defaults['date_available']); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="field">
                    ...
                    <input type="number"
                           ...
                           min="0"
                           placeholder="0.00"
                           value="<?php echo e(old('average_usage_ml', $materialDefaults['average_usage_ml'] ?? '')); ?>">
                ...
                <div class="form-buttons">
                    <button type="submit" class="btn-save" id="submit-btn">
                        <span class="btn-text"><?php echo e($isEditing ? 'Update Giveaways' : 'Create Giveaways'); ?></span>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\leanne\xampp\htdocs\InkWise-Web\ink-wise\resources\views/admin/products/create-giveaways.blade.php ENDPATH**/ ?>