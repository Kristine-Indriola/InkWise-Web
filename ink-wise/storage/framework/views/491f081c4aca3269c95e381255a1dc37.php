...
<script>
  document.addEventListener("alpine:init", () => {
    Alpine.data("chatBot", () => ({
      ...
      async loadQAs() {
        try {
          const res = await fetch("<?php echo e(route('chatbot.qas')); ?>", { headers: { 'Accept': 'application/json' }});
...
<?php /**PATH C:\Users\leanne\xampp\htdocs\InkWise-Web\ink-wise\resources\views/customer/partials/chatbot.blade.php ENDPATH**/ ?>