...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/customer/orderflow-giveaways.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/customer/preview-modal.css')); ?>">
...
<body class="antialiased bg-white min-h-screen envelope-body">
            ...
            <div class="flex items-center gap-3 lg:gap-6">
                ...
                <nav id="primaryNav" class="hidden lg:flex">
                    <ul class="flex items-center gap-4 text-sm font-semibold text-gray-700">
                        ...
                        <li>
                            <a href="<?php echo e(route('order.envelope')); ?>"
                               class="inline-flex items-center gap-2 rounded-full px-4 py-2 transition hover:text-[#4338ca]"
                               aria-current="false">
                                Envelope
                            </a>
                        ...
                        <li>
                            <a href="<?php echo e(route('order.giveaways')); ?>"
                        ...
                        <li>
                            <a href="<?php echo e(route('order.summary')); ?>"
                               class="inline-flex items-center gap-2 rounded-full px-4 py-2 transition hover:text-[#4338ca]"
                               aria-current="false">
                                Summary
                            </a>
                ...
                <div class="flex items-center gap-3">
                    <form action="<?php echo e(url('/search')); ?>" method="GET" class="hidden lg:flex">
                        ...
                        <input id="desktop-giveaway-search" type="text" name="query" value="<?php echo e($searchValue); ?>" placeholder="Search giveaways..."
        ...
        <div id="mobileNavPanel" class="mx-auto hidden w-full max-w-7xl border-t border-[#e0e7ff] bg-white px-4 pb-6 pt-4 shadow-inner lg:hidden">
            <div class="space-y-5">
                <form action="<?php echo e(url('/search')); ?>" method="GET">
                    ...
                    <input id="mobile-giveaway-search" type="text" name="query" value="<?php echo e($searchValue); ?>" placeholder="Search giveaways..."
    ...
    <main class="giveaways-shell envelope-shell pt-24 sm:pt-28"
		  data-summary-url="<?php echo e(route('order.summary')); ?>"
		  data-summary-api="<?php echo e(route('order.summary.json')); ?>"
		  data-options-url="<?php echo e(route('api.giveaways')); ?>"
		  data-sync-url="<?php echo e(route('order.giveaways.store')); ?>"
		  data-clear-url="<?php echo e(route('order.giveaways.clear')); ?>"
		  data-storage-key="inkwise-finalstep"
		  data-placeholder="<?php echo e(asset('images/no-image.png')); ?>">
        <header class="giveaways-header envelope-header">
            <div class="giveaways-header__content envelope-header__content">
                <a href="<?php echo e(route('order.envelope')); ?>" class="giveaways-header__back envelope-header__back" aria-label="Back to envelope options">
        ...
        <div class="giveaways-layout envelope-layout">
            ...
            <aside class="giveaways-summary envelope-summary">
                ...
                <div class="summary-actions">
                    <a href="<?php echo e(route('order.summary')); ?>" class="btn btn-secondary" id="skipGiveawaysBtn" data-target="<?php echo e(route('order.summary')); ?>" role="button">Skip giveaways</a>
                    <button type="button" class="primary-action" id="giveawaysContinueBtn" data-target="<?php echo e(route('order.summary')); ?>" disabled>Continue to checkout</button>
                </div>
    ...
    <?php if(!empty($initialCatalog)): ?>
        <script id="giveawayCatalogData" type="application/json">
            <?php echo \Illuminate\Support\Js::from($initialCatalog); ?>

        </script>
    <?php endif; ?>
    <script src="<?php echo e(asset('js/customer/preview-modal.js')); ?>" defer></script>
    <script src="<?php echo e(asset('js/customer/orderflow-giveaways.js')); ?>" defer></script>
...
<?php /**PATH C:\Users\leanne\xampp\htdocs\InkWise-Web\ink-wise\resources\views/customer/orderflow/giveaways.blade.php ENDPATH**/ ?>