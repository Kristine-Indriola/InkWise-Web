...
<head>
	...
	<link rel="stylesheet" href="<?php echo e(asset('css/customer/review.css')); ?>">
	<script src="<?php echo e(asset('js/customer/review.js')); ?>" defer></script>
</head>
<body>
<?php
...
?>
	...
	<div class="review-shell">
			...
			<div class="preview-layout">
				<div class="review-panel">
					...
					<div class="warning-card" role="alert">
						...
						<ul id="placeholderList" class="placeholder-list" data-expanded="false">
							<?php $__currentLoopData = $placeholderItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				...
				<div class="preview-display">
					<div class="preview-header">
						...
						<?php if($lastEditedAt): ?>
							<div class="preview-timestamp">
								...
								<time datetime="<?php echo e($lastEditedAt); ?>" title="<?php echo e(\Carbon\Carbon::parse($lastEditedAt)->format('l, F j, Y \a\t g:i A')); ?>">
									<?php echo e(\Carbon\Carbon::parse($lastEditedAt)->diffForHumans()); ?>
					...
					<div class="card-flip">
						<div class="inner">
							<div class="card-face front">
								<?php if($customerReview && !empty($customerReview->design_svg)): ?>
								...
								<?php else: ?>
									<img src="<?php echo e($frontImage); ?>" alt="Front of your design" loading="lazy" decoding="async">
								<?php endif; ?>
							</div>
							<div class="card-face back">
								<?php if(!empty($backSvg)): ?>
								...
								<?php else: ?>
									<img src="<?php echo e($backImage); ?>" alt="Back of your design" loading="lazy" decoding="async">
								<?php endif; ?>
							</div>
						</div>
					</div>
					...
					<div class="preview-meta">
						<div><span class="meta-label">Product:</span> <?php echo e($product->name ?? optional($templateRef)->name ?? 'Custom Invitation'); ?></div>
						<?php if(isset($product->size)): ?>
							<div><span class="meta-label">Size:</span> <?php echo e($product->size); ?></div>
						<?php endif; ?>
						<?php if(isset($product->paper_stock)): ?>
							<div><span class="meta-label">Paper stock:</span> <?php echo e($product->paper_stock); ?></div>
						<?php endif; ?>
					</div>
				</div>
			</div>
		...
		<section class="confirm-card">
			...
			<?php if($customerReview): ?>
				<div class="customer-review">
					...
					<?php if(!is_null($customerReview->rating)): ?>
						<p><strong>Rating:</strong> <?php echo e($customerReview->rating); ?>/5</p>
					<?php endif; ?>
					<?php if(!empty($customerReview->review_text)): ?>
						<p class="review-text"><?php echo e($customerReview->review_text); ?></p>
					<?php else: ?>
						<p class="review-text text-muted">No review text saved.</p>
					<?php endif; ?>
					<p class="review-date">Last updated: <?php echo e(optional($customerReview->updated_at ?? $customerReview->created_at)->format('M d, Y h:i A')); ?></p>
				</div>
			<?php endif; ?>
	    ...
	    <button type="button"
	    	id="continueBtn"
	    	data-href="<?php echo e($continueHref ?? ''); ?>"
	    	data-save-url="<?php echo e(route('order.review.continue')); ?>"
	    	disabled
	    >
					Continue
				</button>

				<a href="<?php echo e($editHref); ?>" class="edit-link">Edit my design</a>
			</div>
		</section>
	</div>
...
<?php /**PATH C:\Users\leanne\xampp\htdocs\InkWise-Web\ink-wise\resources\views/customer/orderflow/review.blade.php ENDPATH**/ ?>