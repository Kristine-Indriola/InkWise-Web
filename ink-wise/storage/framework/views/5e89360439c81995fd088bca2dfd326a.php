...
<?php $__env->startPush('styles'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/admin-css/dashboard.css')); ?>">
        <style>
                .page-header {
                        display: flex;
...
<main class="admin-page-shell dashboard-page" role="main">
    ...
    <?php $__currentLoopData = $materialAlertsData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alert): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
            $alertItems = collect($alert['items'] ?? [])->take(5)->implode(', ');
        ?>
        <div class="alert-banner alert-banner--<?php echo e($alert['type'] === 'critical' ? 'critical' : 'warning'); ?>" role="alert">
            <strong><?php echo e($alert['type'] === 'critical' ? 'Critical inventory alert' : 'Upcoming restock needed'); ?></strong>
            <span><?php echo e($alert['message']); ?></span>
            <?php if($alertItems): ?>
                <span><em>Focus:</em> <?php echo e($alertItems); ?></span>
            <?php endif; ?>
        </div>
        ...
        <section class="announcement-board" aria-label="System announcements">
            ...
            <?php $__currentLoopData = $announcements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $announcement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="announcement-board__item">
                    <strong><?php echo e($announcement['title'] ?? 'Notice'); ?></strong>
                    <p style="margin:0.35rem 0;"><?php echo e($announcement['message'] ?? ''); ?></p>
                    <?php if(!empty($announcement['timestamp'])): ?>
                        <small class="review-author"><?php echo e(\Carbon\Carbon::parse($announcement['timestamp'])->format('M d, Y h:i A')); ?></small>
                    <?php endif; ?>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </section>
    ...
    <section class="dashboard-grid" aria-label="System controls">
        <article class="dashboard-card">
            ...
            <div class="shortcut-grid">
                <?php $__empty_1 = true; $__currentLoopData = $systemShortcutsData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shortcut): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <a href="<?php echo e($shortcut['route']); ?>" class="shortcut-card" style="text-decoration:none; color:inherit;">
                        <span style="font-size:1.5rem;"><?php echo e($shortcut['icon']); ?></span>
                        <strong><?php echo e($shortcut['label']); ?></strong>
                        <span style="font-size:0.85rem; color:var(--admin-text-secondary);"><?php echo e($shortcut['description']); ?></span>
                    </a>
    ...
    <section class="chart-grid" aria-label="Key operational charts">
        <article class="chart-card">
            ...
            <div class="insight-chart insight-chart--medium">
                <canvas id="orderStatusChart" data-chart='<?php echo json_encode($orderStatusChart, 15, 512) ?>'></canvas>
                <p id="orderStatusChartEmpty" class="chart-card__empty" <?php if($orderStatusHasData): ?> hidden <?php endif; ?>>No order status data to visualise yet.</p>
            </div>
        </article>
        <article class="chart-card">
            <header class="chart-card__header">
            ...
            <div class="insight-chart insight-chart--medium">
                <canvas id="paymentStatusChart" data-chart='<?php echo json_encode($paymentStatusChart, 15, 512) ?>'></canvas>
                <p id="paymentStatusChartEmpty" class="chart-card__empty" <?php if($paymentStatusHasData): ?> hidden <?php endif; ?>>No payment state data available.</p>
            </div>
        </article>
        <article class="chart-card">
            <header class="chart-card__header">
            ...
            <div class="insight-chart insight-chart--compact">
                <canvas id="inventoryMixChart" data-chart='<?php echo json_encode($inventoryChart, 15, 512) ?>'></canvas>
                <p id="inventoryMixChartEmpty" class="chart-card__empty" <?php if($inventoryHasData): ?> hidden <?php endif; ?>>No inventory metrics recorded yet.</p>
            </div>
        </article>
        <article class="chart-card">
            <header class="chart-card__header">
            ...
            <div class="insight-chart insight-chart--wide">
                <canvas id="topCustomersChart" data-chart='<?php echo json_encode($topCustomersChart, 15, 512) ?>'></canvas>
                <p id="topCustomersChartEmpty" class="chart-card__empty" <?php if($topCustomersHasData): ?> hidden <?php endif; ?>>Customer insights will appear once orders are completed.</p>
            </div>
        </article>
    </section>
    ...
    <section class="dashboard-grid" aria-label="Sales performance">
        ...
        <article class="dashboard-card">
            ...
            <div class="sales-chart-wrapper" role="img" aria-label="Weekly sales trend chart">
                ...
                <canvas id="salesTrendChart"
                    data-labels='<?php echo json_encode($salesPreviewData['trend']['labels'] ?? [], 15, 512) ?>'
                    data-values='<?php echo json_encode($salesPreviewData['trend']['values'] ?? [], 15, 512) ?>'>
                </canvas>
            </div>
        </article>
        <article class="dashboard-card">
            <header class="dashboard-card__header">
                ...
                <a href="<?php echo e(route('admin.reports.sales')); ?>" class="pill-link">View sales report</a>
            </header>
            <div class="insight-grid">
                <div class="insight-card">
                    <span class="insight-meta-label">Revenue</span>
                    <span class="insight-meta-value">₱<?php echo e(number_format($yearToDateCurrent['sales'] ?? 0, 2)); ?></span>
                    <span class="insight-meta-caption">Prior: ₱<?php echo e(number_format($yearToDatePrevious['sales'] ?? 0, 2)); ?></span>
                    <?php if(is_array($yearToDateSalesDelta)): ?>
                        <?php
                        ...
                        ?>
                        <span class="<?php echo e($ytdSalesClass); ?>" title="Revenue change vs prior YTD">
                            <span class="insight-delta__icon"><?php echo e($ytdSalesSymbol); ?></span><?php echo e(number_format($ytdSalesPercent, 1)); ?>%
                        </span>
                    <?php endif; ?>
                </div>
                <div class="insight-card">
                    <span class="insight-meta-label">Orders</span>
                    <span class="insight-meta-value"><?php echo e(number_format($yearToDateCurrent['orders'] ?? 0)); ?></span>
                    <span class="insight-meta-caption">Prior: <?php echo e(number_format($yearToDatePrevious['orders'] ?? 0)); ?></span>
                    <?php if(is_array($yearToDateOrdersDelta)): ?>
                        <?php
                        ...
                        ?>
                        <span class="<?php echo e($ytdOrdersClass); ?>" title="Order change vs prior YTD">
                            <span class="insight-delta__icon"><?php echo e($ytdOrdersSymbol); ?></span><?php echo e(number_format($ytdOrdersPercent, 1)); ?>%
                        </span>
                    <?php endif; ?>
                </div>
                <div class="insight-card">
                    <span class="insight-meta-label">Average order value</span>
                    <span class="insight-meta-value">₱<?php echo e(number_format($yearToDateCurrent['average'] ?? 0, 2)); ?></span>
                    <span class="insight-meta-caption">Prior: ₱<?php echo e(number_format($yearToDatePrevious['average'] ?? 0, 2)); ?></span>
                </div>
            </div>
        </article>
        <article class="dashboard-card">
                    ...
                    <li>
                        <div style="display:flex; align-items:center; gap:0.75rem;">
                            <div style="width:56px; height:56px; border-radius:0.75rem; overflow:hidden; background:#f3f4f6; border:1px solid rgba(15, 23, 42, 0.08); flex-shrink:0;">
                                <img src="<?php echo e($productImage); ?>" alt="<?php echo e($product->label); ?> preview" style="width:100%; height:100%; object-fit:cover;">
                            </div>
                            <div>
                                <strong><?php echo e($product->label); ?></strong> – ₱<?php echo e(number_format($product->total_revenue ?? 0, 2)); ?>

                                <span class="insight-meta-caption" style="display:block;"><?php echo e(number_format($product->orders_count ?? 0)); ?> orders · <?php echo e(number_format($product->quantity ?? 0)); ?> units</span>
                            </div>
                        </div>
                    </li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        ...
        <article class="dashboard-card">
            <header class="dashboard-card__header">
                ...
                <a href="<?php echo e(route('admin.payments.index')); ?>" class="pill-link">View payments</a>
            </header>
            <ul class="analytics-card__list" style="margin:0;">
                <?php $__empty_1 = true; $__currentLoopData = $recentTransactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    ?>
                    <li>
                        <strong><?php echo e($transactionLabel); ?></strong> – ₱<?php echo e(number_format($transactionAmount, 2)); ?>

                        <span class="insight-meta-caption" style="display:block;">
                            <?php echo e($transactionMethod); ?> · <?php echo e($transactionStatus); ?> · <?php echo e($transactionTime); ?>
    ...
    <section class="dashboard-grid" aria-label="Customer insights">
        ...
        <article class="dashboard-card">
            <header class="dashboard-card__header">
                ...
                <a href="<?php echo e(route('admin.customers.index')); ?>" class="pill-link">View customers</a>
            </header>
            <div class="popular-designs-content">
                <div class="popular-designs-chart-section">
                    <div class="behavior-chart">
                        <div class="insight-chart insight-chart--compact insight-chart--slim" style="margin:0;">
                            ...
                            <canvas id="popularDesignsMiniChart" data-chart='<?php echo json_encode($popularDesignsChart, 15, 512) ?>'></canvas>
                            <p id="popularDesignsMiniEmpty" class="chart-card__empty" <?php if($popularDesignsHasData): ?> hidden <?php endif; ?>>Popular designs populate once orders accumulate.</p>
                        </div>
                    </div>
                </div>
                <div class="popular-designs-grid-section">
                    ...
                    <div class="popular-designs-grid">
                        <?php $__empty_1 = true; $__currentLoopData = $popularDesignsWithImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $design): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="popular-design-item">
                                <div class="popular-design-image">
                                    <?php if($design['image']): ?>
                                        <img src="<?php echo e($design['image']); ?>" alt="<?php echo e($design['name']); ?>" loading="lazy" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                                ...
                                <div class="popular-design-info">
                                    <div class="popular-design-name"><?php echo e($design['short_name']); ?></div>
                                    <div class="popular-design-count"><?php echo e(number_format($design['count'])); ?> selections</div>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        ...
        <article class="dashboard-card">
            ...
            <div class="behavior-chart">
                <div class="insight-chart insight-chart--compact insight-chart--slim" style="margin:0;">
                    ...
                    <canvas id="repeatCustomersSplitChart" data-chart='<?php echo json_encode($repeatVsNewChart, 15, 512) ?>'></canvas>
                    <p id="repeatCustomersSplitEmpty" class="chart-card__empty" <?php if($repeatVsNewHasData): ?> hidden <?php endif; ?>>Customer mix appears when orders complete.</p>
                </div>
            </div>
        </article>
        <article class="dashboard-card">
        ...
        <article class="dashboard-card">
            ...
            <div class="behavior-chart">
                <div class="insight-chart insight-chart--compact insight-chart--slim" style="margin:0;">
                    ...
                    <canvas id="dayOfWeekOrdersChart" data-chart='<?php echo json_encode($dayOfWeekChart, 15, 512) ?>'></canvas>
                    <p id="dayOfWeekOrdersEmpty" class="chart-card__empty" <?php if($dayOfWeekHasData): ?> hidden <?php endif; ?>>Day-of-week trends will display once history is populated.</p>
                </div>
                <span class="insight-meta-caption" style="display:block; margin-top:0.4rem;">
                    <?php if($dayOfWeekTop && ($dayOfWeekTop['total'] ?? 0) > 0): ?>
                        Busiest day: <?php echo e($dayOfWeekTop['label']); ?> (<?php echo e(number_format($dayOfWeekTop['total'])); ?> orders).
                    <?php else: ?>
        ...
        <article class="dashboard-card">
            ...
            <div style="margin-top:0.85rem;">
                <div class="insight-chart insight-chart--wide insight-chart--slim" style="margin-bottom:0.65rem;">
                    <canvas id="peakOrderDaysMiniChart" data-chart='<?php echo json_encode($peakOrderDaysChart, 15, 512) ?>'></canvas>
                    <p id="peakOrderDaysMiniEmpty" class="chart-card__empty" <?php if($peakOrderDaysHasData): ?> hidden <?php endif; ?>>Peak order patterns will plot once daily data is available.</p>
                </div>
                <ul class="analytics-card__list analytics-card__list--dense" style="margin:0;">
                    <?php $__empty_1 = true; $__currentLoopData = collect($customerInsightsData['peakOrderDays']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <li><?php echo e($day['day']); ?> – <?php echo e(number_format($day['total_orders'])); ?> orders</li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    ...
    <section class="dashboard-grid" aria-label="Inventory">
        ...
        <article class="dashboard-card">
            ...
            <div class="stock-status-content">
                <div class="stock-chart-section">
                    ...
                    <div class="insight-chart insight-chart--wide">
                        <canvas id="materialStockChart" data-chart='<?php echo json_encode($materialStockChart, 15, 512) ?>'></canvas>
                        <p id="materialStockChartEmpty" class="chart-card__empty" <?php if($materialStockHasData): ?> hidden <?php endif; ?>>No data</p>
                    </div>
                </div>
                    ...
                    <div class="stock-alerts-grid">
                        <div class="stock-alert">
                            ...
                            <ul class="analytics-card__list analytics-card__list--dense" style="margin:0.25rem 0 0 0;">
                                <?php $__empty_1 = true; $__currentLoopData = collect($inventoryMonitorData['lowStockMaterials'])->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $material): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <?php $stock = (int) (optional($material->inventory)->stock_level ?? $material->stock_qty ?? 0); ?>
                                    <li style="font-size:0.8rem;"><?php echo e(Str::limit($material->material_name, 18)); ?> · <?php echo e(number_format($stock)); ?></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        ...
                        <div class="stock-alert">
                            ...
                            <ul class="analytics-card__list analytics-card__list--dense" style="margin:0.25rem 0 0 0;">
                                <?php $__empty_1 = true; $__currentLoopData = collect($inventoryMonitorData['outOfStockMaterials'])->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $material): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <li style="font-size:0.8rem;"><?php echo e(Str::limit($material->material_name, 18)); ?></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        ...
        <article class="dashboard-card">
            ...
            <div class="movement-log" style="max-height:150px;" aria-label="Recent stock movements">
                <?php $__empty_1 = true; $__currentLoopData = collect($inventoryMonitorData['movementLogs'])->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                    ...
                    <div class="movement-log__entry" style="padding:0.5rem 0; border-bottom:1px solid var(--admin-border);">
                        <strong style="font-size:0.9rem;"><?php echo e($movementType); ?> · <?php echo e(Str::limit($movement->material->material_name ?? 'Unknown', 25)); ?></strong>
                        <div class="movement-log__meta" style="font-size:0.8rem;"><?php echo e($quantity); ?> <?php echo e($unit); ?> · <?php echo e(optional($movement->created_at)->diffForHumans()); ?></div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            ...
            <div style="margin-top:0.5rem;">
                <a href="<?php echo e(route('admin.materials.index')); ?>" class="pill-link">Materials</a>
                <a href="<?php echo e(route('admin.inventory.index')); ?>" class="pill-link" style="margin-left:0.5rem;">History</a>
            </div>
        </article>
        ...
        <article class="dashboard-card">
            ...
            <div class="demand-analysis-content">
                <div class="demand-chart-section">
                    ...
                    <div class="insight-chart insight-chart--wide">
                        <canvas id="demandTrendsChart" data-chart='<?php echo json_encode($demandTrendsChart ?? [], 15, 512) ?>'></canvas>
                        <p id="demandTrendsChartEmpty" class="chart-card__empty" <?php if(!empty($demandTrendsChart) && count($demandTrendsChart['datasets'] ?? []) > 0): ?> hidden <?php endif; ?>>No demand data available yet.</p>
                    </div>
                </div>
                    ...
                    <div class="demand-insights-grid">
                        <div class="demand-insight-card">
                            ...
                            <div class="demand-insight-value">
                                <?php if(!empty($demandInsights['peakPeriod'])): ?>
                                    <?php echo e($demandInsights['peakPeriod']['period'] ?? 'N/A'); ?>

                                    <span class="demand-insight-subtext"><?php echo e($demandInsights['peakPeriod']['usage'] ?? 0); ?> units</span>
                                <?php else: ?>
                                    Analyzing...
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="demand-insight-card">
                            ...
                            <div class="demand-insight-value">
                                <?php if(!empty($demandInsights['lowPeriod'])): ?>
                                    <?php echo e($demandInsights['lowPeriod']['period'] ?? 'N/A'); ?>

                                    <span class="demand-insight-subtext"><?php echo e($demandInsights['lowPeriod']['usage'] ?? 0); ?> units</span>
                                <?php else: ?>
                                    Analyzing...
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="demand-insight-card">
                            ...
                            <div class="demand-insight-value">
                                <?php if(!empty($demandInsights['recommendedReorder'])): ?>
                                    <?php echo e(number_format($demandInsights['recommendedReorder'])); ?> units
                        ...
                        <div class="demand-insight-card">
                            ...
                            <div class="demand-insight-value">
                                <?php if(!empty($demandInsights['trend'])): ?>
                                    <?php if($demandInsights['trend'] === 'increasing'): ?>
                                        <span style="color: #28a745;">↗️ Increasing</span>
                                    <?php elseif($demandInsights['trend'] === 'decreasing'): ?>
                                        <span style="color: #dc3545;">↘️ Decreasing</span>
                                    <?php else: ?>
                                        <span style="color: #6c757d;">➡️ Stable</span>
                                    <?php endif; ?>
                                    <span class="demand-insight-subtext"><?php echo e(number_format(abs($demandInsights['trendPercent'] ?? 0), 1)); ?>% change</span>
                                <?php else: ?>
                                    Analyzing...
                                <?php endif; ?>
                            </div>
            ...
            <div style="margin-top:0.5rem;">
                <a href="<?php echo e(route('admin.reports.inventory')); ?>" class="pill-link">View Details</a>
                <a href="<?php echo e(route('admin.inventory.index')); ?>" class="pill-link" style="margin-left:0.5rem;">Manage Stock</a>
            </div>
        </article>
    </section>
    ...
    <section class="dashboard-grid" aria-label="Activity and scheduling">
        <article class="dashboard-card">
            ...
            <div class="activity-feed">
                <?php $__empty_1 = true; $__currentLoopData = $recentActivityData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                    ...
                    <div class="activity-entry">
                        <span><?php echo e($entry['message'] ?? 'Update recorded.'); ?></span>
                        <span class="activity-entry__timestamp">
                            <?php echo e(optional($timestamp)->format('M d, Y h:i A')); ?>

                            <?php if(($entry['type'] ?? null) === 'order' && !empty($entry['order'])): ?> · Order <?php echo e($entry['order']); ?> <?php endif; ?>
                            <?php if(!empty($entry['actor'])): ?> · <?php echo e($entry['actor']); ?> <?php endif; ?>
                        </span>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        ...
        <article class="dashboard-card">
            <header class="dashboard-card__header">
                ...
                <a href="<?php echo e($upcomingCalendarData['calendarRoute'] ?? route('admin.reports.pickup-calendar')); ?>" class="pill-link">Open calendar</a>
            </header>
            <?php if(!empty($materialAlertsData)): ?>
            ...
            <div class="pickup-calendar">
                <?php $__currentLoopData = $calendarDays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dateKey => $dayData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="calendar-day <?php echo e($dayData['date']->isToday() ? 'today' : ''); ?> <?php echo e($dayData['pickups']->isNotEmpty() ? 'has-pickups' : ''); ?>">
                        <div class="calendar-day-header">
                            <span class="day-name"><?php echo e($dayData['date']->format('D')); ?></span>
                            <span class="day-number"><?php echo e($dayData['date']->format('j')); ?></span>
                        </div>
                        <div class="calendar-day-pickups">
                            <?php $__empty_1 = true; $__currentLoopData = $dayData['pickups']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pickup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="pickup-item">
                                    <div class="pickup-order"><?php echo e($pickup['order_number']); ?></div>
                                    <div class="pickup-details">
                                        <span class="pickup-amount">₱<?php echo e(number_format($pickup['total_amount'] ?? 0, 2)); ?></span>
                                        <span class="pickup-status <?php echo e($pickup['status'] ?? 'pending'); ?>"><?php echo e(Str::title(str_replace('_', ' ', $pickup['status'] ?? 'pending'))); ?></span>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            ...
            <?php if($groupedPickups->has('unscheduled')): ?>
                <div class="unscheduled-pickups">
                    <h4>Unscheduled Pickups</h4>
                    <ul class="analytics-card__list" style="margin:0;">
                        <?php $__currentLoopData = $groupedPickups['unscheduled']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pickup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                <strong><?php echo e($pickup['order_number']); ?></strong>
                                <span> · ₱<?php echo e(number_format($pickup['total_amount'] ?? 0, 2)); ?></span>
                                <span> · <?php echo e(Str::title(str_replace('_', ' ', $pickup['status'] ?? 'pending'))); ?></span>
                            </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\leanne\xampp\htdocs\InkWise-Web\ink-wise\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>