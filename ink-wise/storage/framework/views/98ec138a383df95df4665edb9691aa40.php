...
<main
	...
	data-export-url="<?php echo e($exportUrl); ?>"
	data-print-url="<?php echo e($printUrl); ?>"
	data-current-status="<?php echo e($currentStatus); ?>"
	data-status-labels='<?php echo json_encode($statusOptions, 15, 512) ?>'
	data-status-flow='<?php echo json_encode($statusFlow, 15, 512) ?>'
>
	<header class="page-header ordersummary-page-header">
		<div>
			<h1 class="page-title"><?php echo e($orderTitle); ?></h1>
			<p class="page-subtitle">
				Placed <?php echo e($placedAt); ?> · <?php echo e($paymentStatusLabel); ?> payment · <?php echo e($getStatusLabel($fulfillmentStatus)); ?> fulfillment
			</p>
		</div>
	...
	<section class="ordersummary-banner" aria-live="polite">
		<div class="ordersummary-banner__status">
			<span class="status-chip <?php echo e('status-chip--' . $paymentStatus); ?>" data-payment-indicator>
				<?php echo e($paymentStatusLabel); ?> payment
			</span>
			<span class="status-chip status-chip--outline <?php echo e('status-chip--' . $fulfillmentStatus); ?>" data-fulfillment-indicator>
				<?php echo e($getStatusLabel($fulfillmentStatus)); ?> 
			</span>
		</div>
		<div class="ordersummary-banner__meta">
			<span class="ordersummary-banner__id">
				<strong>Order ID:</strong> <?php echo e($orderNumber); ?>

			</span>
			<span class="ordersummary-banner__date">
				<strong>Placed:</strong> <?php echo e($placedAt); ?>
	...
	<section class="status-progress-card" data-status-card>
		<header class="status-progress-card__header">
			...
			<div class="status-progress-card__actions">
				<span class="order-stage-chip order-stage-chip--<?php echo e($currentChipModifier); ?>" data-status-chip>
					<?php echo e($currentStatusLabel); ?>

				</span>
				<?php if($statusManageUrl && $paymentStatus !== 'pending' && $currentStatus !== 'completed'): ?>
					<a href="<?php echo e($statusManageUrl); ?>" class="status-progress-manage-link">Update status</a>
				...
				<?php endif; ?>
				<?php if($paymentManageUrl): ?>
					<a href="<?php echo e($paymentManageUrl); ?>" class="status-progress-manage-link">Payment Details</a>
				<?php endif; ?>
			</div>
		</header>
		<ol class="status-tracker" aria-hidden="true">
			<?php $__currentLoopData = $statusFlow; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $statusKey): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<?php
				...
				<li class="status-tracker__item <?php echo e($stateClass); ?>" data-status-step="<?php echo e($statusKey); ?>">
					<div class="status-tracker__marker">
						<?php if($stateClass === 'status-tracker__item--done'): ?>
							<span class="status-tracker__icon">✓</span>
						<?php else: ?>
							<span class="status-tracker__number"><?php echo e($index + 1); ?></span>
						<?php endif; ?>
					</div>
					<?php if(!$loop->last): ?>
	...
	<div class="ordersummary-layout">
		<section class="ordersummary-main" aria-label="Order details">
			<article class="ordersummary-card">
				<header class="ordersummary-card__header">
					...
					<span class="ordersummary-card__meta">
						<?php echo e($items->count()); ?> <?php echo e(\Illuminate\Support\Str::plural('item', $items->count())); ?>
							...
							<tbody>
								<?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									...
									<tr>
											...
											<div class="item-cell">
												...
												<?php if($gallery->isNotEmpty()): ?>
													<button
														...
														data-preview-title="<?php echo e($previewTitle); ?>"
														data-preview-gallery='<?php echo json_encode($galleryForClient, 15, 512) ?>'
														data-preview-materials='<?php echo json_encode($itemMaterialsList, 15, 512) ?>'
														aria-label="View artwork preview for <?php echo e($previewTitle); ?>"
													>
														<img src="<?php echo e($primaryImageUrl); ?>" alt="<?php echo e($primaryImageLabel ? $previewTitle . ' ' . strtolower($primaryImageLabel) : $previewTitle . ' preview'); ?>" class="item-cell__thumb">
													</button>
												<?php endif; ?>
												<?php if(!empty($customerReviewSvg) || !empty($originalTemplateSvg)): ?>
													<div class="mt-2">
														<div class="text-xs font-semibold uppercase tracking-wide text-gray-400 mb-2">Template Comparison</div>
														<div class="flex gap-2">
															<?php if(!empty($originalTemplateSvg)): ?>
																<div class="flex flex-col items-center">
																	<div class="text-xs text-gray-500 mb-1">Original</div>
																	<button
																		type="button"
																		class="item-cell__svg-button js-admin-svg-preview-trigger"
																		data-svg-content="<?php echo e(base64_encode($originalTemplateSvg)); ?>"
																		data-back-image="<?php echo e(!empty($originalTemplateBackSvg) ? base64_encode($originalTemplateBackSvg) : ''); ?>"
																		data-preview-title="<?php echo e($previewTitle); ?> - Original Template"
																		aria-label="View original template design for <?php echo e($previewTitle); ?>"
																	...
																	>
																		<div class="svg-thumb-container" style="width: 60px; height: 60px; overflow: hidden; pointer-events: none;">
																			<?php echo $originalTemplateSvg; ?>

																		</div>
																	</button>
																</div>
															<?php endif; ?>
															<?php if(!empty($customerReviewSvg)): ?>
																<div class="flex flex-col items-center">
																	<div class="text-xs text-gray-500 mb-1">Edited</div>
																	<button
																		type="button"
																		class="item-cell__svg-button js-admin-svg-preview-trigger"
																		data-svg-content="<?php echo e(base64_encode($customerReviewSvg)); ?>"
																		data-back-image="<?php echo e(!empty($customerReviewBackImage) && str_contains($customerReviewBackImage, '<svg') ? base64_encode($customerReviewBackImage) : ($customerReviewBackImage ?? '')); ?>"
																		data-preview-title="<?php echo e($previewTitle); ?> - Edited Design"
																		aria-label="View edited template design for <?php echo e($previewTitle); ?>"
																		style="border: 1px solid #e5e7eb; border-radius: 8px; padding: 4px; background: #f8fafc; cursor: pointer; display: inline-block; transition: all 0.2s;"
																		onmouseover="this.style.boxShadow='0 0 0 2px #a6b7ff'"
																		onmouseout="this.style.boxShadow='none'"
																	>
																		<div class="svg-thumb-container" style="width: 60px; height: 60px; overflow: hidden; pointer-events: none;">
																			<?php echo $customerReviewSvg; ?>
												...
												<?php endif; ?>
												<div>
													<strong><?php echo e(data_get($item, 'name', 'Custom product')); ?></strong>
													<?php if(filled(data_get($item, 'sku'))): ?>
														<span class="item-cell__sku">SKU · <?php echo e(data_get($item, 'sku')); ?></span>
													<?php endif; ?>
												</div>
											</div>
										</td>
										...
										<td>
											<?php if($itemMaterialsList->isNotEmpty()): ?>
												<ul class="item-materials">
													<?php $__currentLoopData = $itemMaterialsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $material): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
														<li class="material-item material-item--<?php echo e($material['type']); ?>">
															<span class="material-label"><?php echo e($material['label']); ?></span>
															<?php if($material['quantity'] !== null): ?>
																<span class="material-quantity">x<?php echo e($material['quantity']); ?></span>
															<?php endif; ?>
														</li>
													<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
												</ul>
									...
									<?php if($breakdown->isNotEmpty()): ?>
										<?php $__currentLoopData = $breakdown; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<?php
											...
											<tr class="ordersummary-row--breakdown">
												<td></td>
												<td colspan="1">
													<span class="item-breakdown-label"><?php echo e($row['label']); ?></span>
												</td>
												<td class="text-center"><?php echo e($rowQuantity !== null ? $rowQuantity : '—'); ?></td>
												<td class="text-end" <?php if($rowUnit !== null): ?> data-money <?php endif; ?>>
													<?php echo e($rowUnit !== null ? number_format((float) $rowUnit, 2) : '—'); ?>

												</td>
												<td class="text-end" <?php if($rowTotal !== null): ?> data-money <?php endif; ?>>
													<?php echo e($rowTotal !== null ? number_format((float) $rowTotal, 2) : '—'); ?>
			...
			<?php if($materialsList->isNotEmpty()): ?>
				<article class="ordersummary-card">
					<header class="ordersummary-card__header">
						<h2>Materials needed for production</h2>
						<p class="ordersummary-card__meta"><?php echo e($materialsList->count()); ?> <?php echo e(\Illuminate\Support\Str::plural('material', $materialsList->count())); ?> tracked</p>
					</header>
					<div class="materials-grid">
						<?php $__currentLoopData = $materialsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $material): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<?php
								$typeLabel = 'Other';
							...
							?>
							<div class="material-card material-card--<?php echo e($material['type']); ?>">
								<span class="material-card__type"><?php echo e($typeLabel); ?></span>
								<h3 class="material-card__title"><?php echo e($material['label']); ?></h3>
								<p class="material-card__quantity"><strong><?php echo e($quantityText); ?></strong> units needed</p>
								<?php if(is_numeric($totalValue) && $totalValue > 0): ?>
									<p class="material-card__cost">Total cost · ₱<?php echo e(number_format($totalValue, 2)); ?></p>
								<?php elseif(is_numeric($unitPriceValue) && $unitPriceValue > 0): ?>
									<p class="material-card__cost">Unit cost · ₱<?php echo e(number_format($unitPriceValue, 2)); ?></p>
								<?php else: ?>
			...
			<article class="ordersummary-card">
				<header class="ordersummary-card__header">
					<h2>Customer</h2>
					<?php if($customerTags->isNotEmpty()): ?>
					...
					<div class="ordersummary-card__actions">
						<?php if($customerEmail && $customerId): ?>
							<a href="<?php echo e(route('admin.messages.index')); ?>?start_conversation=<?php echo e($customerId); ?>" class="btn btn-secondary btn-sm">
				...
				<div class="ordersummary-customer">
					<div class="ordersummary-customer__profile">
						<div class="avatar">
							<span aria-hidden="true"><?php echo e(mb_strtoupper(mb_substr($customerName, 0, 1))); ?></span>
						</div>
						<div>
							<h3><?php echo e($customerName); ?></h3>
							<?php if($customerCompany): ?>
								<p class="ordersummary-customer__company"><?php echo e($customerCompany); ?></p>
							<?php endif; ?>
						</div>
					</div>
					...
					<dl class="ordersummary-contact">
						<div>
							...
							<dd>
								<?php if($customerEmail): ?>
									<a href="mailto:<?php echo e($customerEmail); ?>"><?php echo e($customerEmail); ?></a>
									<button type="button" class="chip-action" data-copy="<?php echo e($customerEmail); ?>">
										Copy
									</button>
								<?php else: ?>
									<span>—</span>
						...
						<div>
							...
							<dd>
								<?php if($customerPhone): ?>
									...
									<button type="button" class="chip-action" data-copy="<?php echo e($customerPhone); ?>">
										Copy
									</button>
								<?php else: ?>
									<span>—</span>
						...
						<div>
							...
							<dd>
								<?php if(!empty($customerLifetimePaid) && $customerLifetimePaid > 0): ?>
									<?php echo e($currencySymbol . number_format($customerLifetimePaid, 2)); ?>
			...
			<article class="ordersummary-card">
				...
				<ul class="ordersummary-timeline" data-timeline-list>
					<?php $__empty_1 = true; $__currentLoopData = $timeline; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
						...
						?>
						<li class="timeline-entry timeline-entry--<?php echo e($state); ?>" data-timeline-entry>
							<div class="timeline-entry__bullet" aria-hidden="true"></div>
							<div class="timeline-entry__body">
								<header>
									<h3><?php echo e($label); ?></h3>
									<time datetime="<?php echo e($timestampIso); ?>"><?php echo e($timestampDisplay); ?></time>
								</header>
								<?php if($author || $note): ?>
				...
				<?php if($ratingValue): ?>
					<div class="rating-display" style="padding: 20px;">
						<div class="rating-stars" style="display: flex; align-items: center; gap: 12px; margin-bottom: 16px;">
							...
							<span style="font-size: 18px; font-weight: 600; color: #111827;"><?php echo e($ratingValue); ?>/5</span>
						</div>
						<?php if($ratingComment): ?>
							<div class="rating-comment" style="background: #f9fafb; border: 1px solid #e5e7eb; border-radius: 8px; padding: 16px; margin-bottom: 16px;">
								<p style="margin: 0; font-style: italic; color: #374151; font-size: 16px; line-height: 1.5;">"<?php echo e($ratingComment); ?>"</p>
							</div>
						<?php endif; ?>
						<?php
							$ratingPhotos = collect(data_get($rating, 'photos', []))->filter();
						?>
						<?php if($ratingPhotos->isNotEmpty()): ?>
							<div class="rating-photos-section">
								...
								<div class="rating-photos">
									<?php $__currentLoopData = $ratingPhotos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<?php
											$photoUrl = \Illuminate\Support\Str::startsWith($photo, ['http://', 'https://'])
												? $photo
												: \Illuminate\Support\Facades\Storage::disk('public')->url($photo);
										?>
										<a href="<?php echo e($photoUrl); ?>" target="_blank" rel="noopener" style="display: block;">
											<img src="<?php echo e($photoUrl); ?>" alt="Rating photo" class="rating-photo">
										</a>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								</div>
							</div>
			...
			<?php if($deductedMaterials->isNotEmpty()): ?>
				<article class="ordersummary-card">
					<header class="ordersummary-card__header">
		...
		<aside
			...
			data-schedule-pickup-url="<?php echo e($schedulePickupUrl); ?>"
			data-customer-email="<?php echo e($customerEmail); ?>"
		>
			<section class="sidebar-card sidebar-card--totals">
				...
				<div class="payment-status-highlight" data-payment-highlight style="background: <?php echo e($paymentSummaryHighlight['background']); ?>; border: 2px solid <?php echo e($paymentSummaryHighlight['border']); ?>; border-radius: 8px; padding: 16px; margin-bottom: 16px; text-align: center;">
					<div data-payment-highlight-title style="font-size: 14px; font-weight: 600; color: <?php echo e($paymentSummaryHighlight['accent']); ?>; margin-bottom: 8px;"><?php echo e($paymentSummaryHighlight['title']); ?></div>
					<span class="status-chip <?php echo e('status-chip--' . $paymentStatus); ?>" data-payment-status-chip style="font-size: 16px; padding: 8px 16px;">
						<?php echo e($paymentStatusLabel); ?>

					</span>
					<p data-payment-highlight-message style="margin: 8px 0 0; font-size: 13px; color: <?php echo e($paymentSummaryHighlight['accent']); ?>;"><?php echo e($paymentSummaryHighlight['message']); ?></p>
				</div>
				<?php
				...
				<div class="payment-summary-grid">
					...
					<div class="payment-summary-grid__item">
						...
						<span class="payment-summary-grid__value" data-payment-total="balance"><?php echo e($formatCurrency($balanceDue)); ?></span>
					</div>
					<?php if($paymentMethodDisplay): ?>
						<div class="payment-summary-grid__item">
							<span class="payment-summary-grid__label">Payment method</span>
							<span class="payment-summary-grid__value"><?php echo e(mb_strtoupper($paymentMethodDisplay)); ?></span>
						</div>
					<?php endif; ?>
					<?php if($primaryProvider): ?>
						<div class="payment-summary-grid__item">
							<span class="payment-summary-grid__label">Provider</span>
							<span class="payment-summary-grid__value"><?php echo e(ucfirst($primaryProvider)); ?></span>
						</div>
					<?php endif; ?>
					<?php if($latestPaymentAt): ?>
						<div class="payment-summary-grid__item">
							<span class="payment-summary-grid__label">Latest payment</span>
							<span class="payment-summary-grid__value"><?php echo e($latestPaymentAt); ?></span>
						</div>
					<?php endif; ?>
				</div>
				<?php if($orderGrandTotal > 0): ?>
					<?php if($totalPaid <= 0): ?>
						<div class="payment-alert payment-alert--pending">No payments recorded yet.</div>
					<?php elseif($balanceDue > 0.01): ?>
						<div class="payment-alert payment-alert--balance">Remaining balance of <?php echo e($formatCurrency($balanceDue)); ?> is pending.</div>
					<?php else: ?>
				...
				<dl class="sidebar-totals" data-sidebar-section>
					<div>
						<dt>Invitations</dt>
						<dd data-money><?php echo e(number_format($groupSums['invitations'] ?? 0, 2)); ?></dd>
					</div>
					<div>
						<dt>Paper stock</dt>
						<dd data-money><?php echo e(number_format($groupSums['paper_stock'] ?? 0, 2)); ?></dd>
					</div>
					<div>
						<dt>Add-ons</dt>
						<dd data-money><?php echo e(number_format($groupSums['addons'] ?? 0, 2)); ?></dd>
					</div>
					<div>
						<dt>Envelopes</dt>
						<dd data-money><?php echo e(number_format($groupSums['envelopes'] ?? 0, 2)); ?></dd>
					</div>
					<div>
						<dt>Giveaways</dt>
						<dd data-money><?php echo e(number_format($groupSums['giveaways'] ?? 0, 2)); ?></dd>
					</div>
					<?php if(!empty($groupSums['others']) && (float) $groupSums['others'] !== 0.0): ?>
						<div>
							<dt>Other line items</dt>
							<dd data-money><?php echo e(number_format($groupSums['others'] ?? 0, 2)); ?></dd>
						</div>
					<?php endif; ?>
					<div>
						<dt>Subtotal</dt>
						<?php
							...
							$grandTotal = $subtotal;
						?>
						<dd data-money><?php echo e(number_format($subtotal, 2)); ?></dd>
					</div>
					<div class="sidebar-totals__total">
						<dt>Total due</dt>
						<dd data-grand-total data-money><?php echo e(number_format($grandTotal, 2)); ?></dd>
					</div>
				</dl>
					...
					<div class="payment-history">
						...
						<?php $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							...
							<div class="payment-history__row">
								<div>
									<div class="payment-history__amount"><?php echo e($formatCurrency($paymentAmount)); ?></div>
									<?php if($metaPieces !== ''): ?>
										<div class="payment-history__meta"><?php echo e($metaPieces); ?></div>
									<?php endif; ?>
								</div>
								<span class="payment-history__status payment-history__status--<?php echo e($statusClass); ?>"><?php echo e(ucfirst($paymentStatus)); ?></span>
							</div>
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					</div>
				<?php endif; ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\leanne\xampp\htdocs\InkWise-Web\ink-wise\resources\views/admin/ordersummary/index.blade.php ENDPATH**/ ?>