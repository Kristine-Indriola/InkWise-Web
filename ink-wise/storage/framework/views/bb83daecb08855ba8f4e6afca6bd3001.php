...
?>
  ...
  <title><?php echo $__env->yieldContent('title', 'InkWise Dashboard'); ?></title>
  <?php echo $__env->yieldPushContent('styles'); ?>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('assets/fontawesome/css/all.min.css')); ?>" onerror="console.warn('Font Awesome local failed to load')">
  ...
  <script>
    (function(){
      ...
      window.__loadProductModalAssets = function(){
        ...
        try { injectStylesheet('<?php echo e(asset("css/admin-css/product.css")); ?>'); } catch(e){}
        return injectScript('<?php echo e(asset("js/admin/product.js")); ?>').then(function(){ window.__productModalAssetsLoaded = true; }).catch(function(){ window.__productModalAssetsLoaded = true; });
      };
...
<body>
  ...
  <div class="sidebar" id="sidebar" style="padding-top:32px;">
    ...
    <ul>
      <li class="<?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>">
        <a href="<?php echo e(route('admin.dashboard')); ?>"><i class="fi fi-rr-house-chimney"></i> <span class="label">Dashboard</span></a>
      </li>
      <li class="<?php echo e(request()->routeIs('admin.products.*') ? 'active' : ''); ?>">
        <a href="<?php echo e(route('admin.products.index')); ?>"><i class="fi fi-rr-boxes"></i> <span class="label">Products</span></a>
      </li>
      <li class="<?php echo e((request()->routeIs('admin.ordersummary.*') || request()->routeIs('admin.orders.index')) ? 'active' : ''); ?>">
        <a href="<?php echo e(route('admin.orders.index')); ?>">
          ...
          <?php if($newOrdersCount > 0): ?>
              <span class="notif-badge"><?php echo e($newOrdersCount); ?></span>
          <?php endif; ?>
        </a>
      </li>
      <li class="<?php echo e(request()->routeIs('admin.reviews.*') ? 'active' : ''); ?>">
        <a href="<?php echo e(route('admin.reviews.index')); ?>">
          ...
          ?>
          <?php if($unrepliedReviewsCount > 0): ?>
              <span class="notif-badge"><?php echo e($unrepliedReviewsCount); ?></span>
          <?php endif; ?>
        </a>
      </li>
      <li class="<?php echo e(request()->routeIs('admin.payments.*') ? 'active' : ''); ?>">
        <a href="<?php echo e(route('admin.payments.index')); ?>"><i class="fi fi-rr-credit-card"></i> <span class="label">Payment Transactions</span></a>
      </li>
      
      <li class="<?php echo e(request()->routeIs('admin.materials.*') ? 'active' : ''); ?>">
        <a href="<?php echo e(route('admin.materials.index')); ?>"><i class="fi fi-rr-blog-pencil"></i> <span class="label">Materials</span></a>
      </li>
      <?php
        $reportsActive = request()->routeIs('admin.reports.*');
      ?>
      <li class="has-submenu <?php echo e($reportsActive ? 'expanded active' : ''); ?>">
        <button type="button" class="submenu-trigger" data-submenu-toggle="reports" aria-expanded="<?php echo e($reportsActive ? 'true' : 'false'); ?>">
          <i class="fi fi-rr-document"></i>
          <span class="label">Reports</span>
          <i class="fi fi-rr-angle-small-down submenu-caret" aria-hidden="true"></i>
        </button>
        <ul class="submenu" data-submenu="reports" aria-hidden="<?php echo e($reportsActive ? 'false' : 'true'); ?>">
          <li class="<?php echo e(request()->routeIs('admin.reports.sales') ? 'active' : ''); ?>">
            <a href="<?php echo e(route('admin.reports.sales')); ?>"><span class="label">Sales</span></a>
          </li>
          <li class="<?php echo e(request()->routeIs('admin.reports.inventory') ? 'active' : ''); ?>">
            <a href="<?php echo e(route('admin.reports.inventory')); ?>"><span class="label">Inventory</span></a>
          </li>
        </ul>
      </li>

          <li class="<?php echo e(request()->routeIs('admin.chatbot.index') ? 'active' : ''); ?>">
  <a href="<?php echo e(route('admin.chatbot.index')); ?>">
    ...
    ?>
      <li class="has-submenu <?php echo e($accountsActive ? 'expanded active' : ''); ?>">
        <button type="button" class="submenu-trigger" data-submenu-toggle="accounts" aria-expanded="<?php echo e($accountsActive ? 'true' : 'false'); ?>">
          <i class="fi fi-rr-users"></i>
          <span class="label">Accounts</span>
          <i class="fi fi-rr-angle-small-down submenu-caret" aria-hidden="true"></i>
        </button>
        <ul class="submenu" data-submenu="accounts" aria-hidden="<?php echo e($accountsActive ? 'false' : 'true'); ?>">
          <li class="<?php echo e(request()->routeIs('admin.customers.*') ? 'active' : ''); ?>">
            <a href="<?php echo e(route('admin.customers.index')); ?>"><span class="label">Customer Accounts</span></a>
          </li>
          <li class="<?php echo e(request()->routeIs('admin.users.*') ? 'active' : ''); ?>">
            <a href="<?php echo e(route('admin.users.index')); ?>"><span class="label">Staff Accounts</span></a>
          </li>
        </ul>
      </li>
      <?php
      ...
      ?>
          <li class="has-submenu <?php echo e($settingsActive ? 'expanded active' : ''); ?>">
        <button type="button" class="submenu-trigger" data-submenu-toggle="settings" aria-expanded="<?php echo e($settingsActive ? 'true' : 'false'); ?>">
          <i class="fi fi-rr-settings"></i>
          <span class="label">Settings</span>
          <i class="fi fi-rr-angle-small-down submenu-caret" aria-hidden="true"></i>
        </button>
        <ul class="submenu" data-submenu="settings" aria-hidden="<?php echo e($settingsActive ? 'false' : 'true'); ?>">
          <li class="<?php echo e(request()->routeIs('admin.settings.site-content.*') ? 'active' : ''); ?>">
            <a href="<?php echo e(route('admin.settings.site-content.edit')); ?>"><span class="label">Site Content</span></a>
          </li>

          <li class="<?php echo e(request()->routeIs('admin.users.passwords.*') ? 'active' : ''); ?>">
            <a href="<?php echo e(route('admin.users.passwords.index')); ?>"><span class="label">Password Reset</span></a>
          </li>
        </ul>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="topbar">
      ...
      <div class="icons" style="display: flex; align-items: center; gap: 24px; margin-left: auto; justify-content: center;">
        <!-- Notification Bell -->
    <a href="<?php echo e(route('admin.notifications')); ?>" class="nav-link notif-btn" title="Notifications" aria-label="Notifications" style="display:flex; align-items:center; justify-content:center;">
      ...
      <?php if($notifCount > 0): ?>
        <span class="notif-badge"><?php echo e($notifCount); ?></span>
      <?php endif; ?>
    </a>
        ...
        <a href="<?php echo e(route('admin.messages.index')); ?>"
           ...
           data-initial-unread="<?php echo e($adminUnreadMessageCount); ?>"
           style="display:flex; align-items:center; justify-content:center;">
          <i class="fi fi-sr-envelope" style="font-size:20px;"></i>
          <?php if($adminUnreadMessageCount > 0): ?>
            <span class="notif-badge" data-role="messages-unread-count"><?php echo e($adminUnreadMessageCount); ?></span>
          <?php endif; ?>
        </a>
        ...
        <div class="profile-dropdown" style="position: relative; display:flex; align-items:center; gap:6px;">
          <a href="<?php echo e(route('admin.profile.edit')); ?>" id="profileImageLink" style="display:flex; align-items:center; text-decoration:none; color:inherit;">
            <?php if($currentAdmin && $currentAdmin->staff && $currentAdmin->staff->profile_pic): ?>
                <img src="<?php echo e(asset('storage/' . $currentAdmin->staff->profile_pic)); ?>"
                     alt="Admin Profile"
...
<?php /**PATH C:\Users\leanne\xampp\htdocs\InkWise-Web\ink-wise\resources\views/layouts/admin.blade.php ENDPATH**/ ?>