...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-section">
                ...
                <div class="addon-rows">
                    <?php $__currentLoopData = $addonRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $addon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="addon-row" data-row-index="<?php echo e($i); ?>">
                        <input type="hidden" name="addons[<?php echo e($i); ?>][id]" value="<?php echo e($addon['id'] ?? ''); ?>">
                        <div class="input-row">
                            <input type="hidden" name="addons[<?php echo e($i); ?>][addon_type]" value="size">
                            <div class="field addon-name-field">
                                <label for="addons_<?php echo e($i); ?>_name">Size Number</label>
                                <select class="addon-name-select" data-placeholder="Select addon material..." name="addons[<?php echo e($i); ?>][material_select]" aria-label="Select addon material">
                                ...
                                <input type="text" id="addons_<?php echo e($i); ?>_name" name="addons[<?php echo e($i); ?>][name]" class="addon-name-input" list="addon-materials-list" placeholder="Select or type material name" value="<?php echo e($addon['name'] ?? ''); ?>">
                                <input type="hidden" name="addons[<?php echo e($i); ?>][material_id]" class="addon-material-id" value="<?php echo e($addon['material_id'] ?? ''); ?>">
                            </div>
                            <div class="field">
                                <label for="addons_<?php echo e($i); ?>_image_path">Image</label>
                                <input type="file" id="addons_<?php echo e($i); ?>_image_path" name="addons[<?php echo e($i); ?>][image_path]" accept="image/*">
                                <?php if(!empty($addon['image_url'])): ?>
                                    <small class="existing-file">Current: <a href="<?php echo e($addon['image_url']); ?>" target="_blank" rel="noopener">View</a></small>
                                <?php endif; ?>
                            </div>
                ...
                <?php if (! $__env->hasRenderedOnce('755ca088-6ac1-4bcf-8869-f4584b75453d')): $__env->markAsRenderedOnce('755ca088-6ac1-4bcf-8869-f4584b75453d'); ?>
                    <datalist id="addon-materials-list">
                        <?php $__currentLoopData = $materials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $materialOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($materialOption->material_name); ?>"><?php echo e($materialOption->material_name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </datalist>
                <?php endif; ?>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\InkWise-Web\ink-wise\resources\views/admin/products/create-invitation.blade.php ENDPATH**/ ?>