<?php $__env->startSection('title', 'Rate Orders'); ?>
...
<div class="rating-page">
    ...
    <?php if($ordersList->isEmpty()): ?>
        <div class="text-center py-12 text-gray-500">
            <p>No completed orders waiting for review.</p>
        </div>
    <?php else: ?>
        <?php $__currentLoopData = $ordersList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
            ...
            <div class="rate-card">
                <div class="rate-card-header">
                    ...
                    <div class="details">
                        ...
                        <span>Order #<?php echo e(data_get($order, 'order_number', $id)); ?></span>
                        <span>Qty: <?php echo e(data_get($order, 'quantity', '—')); ?></span>
                    </div>
                </div>
                ...
                <?php if($isRated): ?>
                    ...
                    <div class="rounded-lg border border-gray-200 bg-white p-4">
                        <div class="flex items-center gap-2 text-sm text-gray-600">
                            ...
                            <span class="flex items-center" aria-label="<?php echo e($ratingLabel); ?> out of 5 stars">
                                <?php for($i = 1; $i <= 5; $i++): ?>
                                    <span class="text-2xl <?php echo e($i <= (int) round($ratingValue) ? 'text-yellow-500' : 'text-gray-300'); ?>">★</span>
                                <?php endfor; ?>
                            </span>
                            <span class="text-gray-500">(<?php echo e($ratingLabel); ?> / 5)</span>
                        </div>
                        <?php if(filled($ratingReview)): ?>
                            <p class="mt-2 text-sm text-gray-700">“<?php echo e($ratingReview); ?>”</p>
                        <?php endif; ?>
                        <?php if($ratingPhotos->isNotEmpty()): ?>
                            <div class="mt-3 flex flex-wrap gap-2">
                                <?php $__currentLoopData = $ratingPhotos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    ?>
                                    <a href="<?php echo e($photoUrl); ?>" target="_blank" rel="noopener" class="block h-20 w-20 overflow-hidden rounded-lg border">
                                        <img src="<?php echo e($photoUrl); ?>" alt="Rating photo" class="h-full w-full object-cover">
                                    </a>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        <?php endif; ?>
                        <?php if($submittedDisplay): ?>
                            <p class="mt-3 text-xs text-gray-400">Submitted <?php echo e($submittedDisplay); ?></p>
                        <?php endif; ?>
                        <p class="mt-3 text-sm text-gray-600">You already rated this order. Thank you for your feedback!</p>
                    </div>
                <?php else: ?>
                <form method="POST" action="<?php echo e(route('customer.order-ratings.store')); ?>" enctype="multipart/form-data" data-rating-form>
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="stars" data-stars>
                        <?php for($i = 1; $i <= 5; $i++): ?>
                            <button type="button" data-star-value="<?php echo e($i); ?>">★</button>
                        <?php endfor; ?>
                    </div>
...
<?php echo $__env->make('layouts.customerprofile', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\leanne\xampp\htdocs\InkWise-Web\ink-wise\resources\views/customer/profile/purchase/rate.blade.php ENDPATH**/ ?>