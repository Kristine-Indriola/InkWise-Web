    ...
    <div class="topbar-inner">
        ...
        <div class="hidden md:flex items-center gap-3 ml-auto">
            ...
            <div class="flex items-center gap-2">
                <a href="<?php echo e(route('customer.notifications')); ?>" class="nav-icon-button" aria-label="Notifications" title="Notifications">
                ...
                <a href="<?php echo e(route('customer.favorites')); ?>" class="nav-icon-button" aria-label="My favorites" title="My favorites">
