...
<head>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/customer/customerprofile.css')); ?>">
    ...
    <script src="<?php echo e(asset('js/customer/customerprofile.js')); ?>" defer></script>
...
<header class="shadow animate-fade-in-down bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 w-full">
        ...
        <nav class="hidden md:flex space-x-6 mx-auto">
            <a href="<?php echo e(route('dashboard')); ?>" class="text-gray-700 hover:text-[#06b6d4]">Home</a>
        ...
        <div class="flex items-center space-x-4 relative">
            <form action="<?php echo e(url('/search')); ?>" method="GET" class="hidden md:flex">
      ...
      <div class="hidden md:flex items-center gap-2">
        ...
        <a href="<?php echo e($favoritesLink['url']); ?>"
           class="nav-icon-button"
           aria-label="<?php echo e($favoritesLink['label']); ?>"
           title="<?php echo e($favoritesLink['label']); ?>"
           <?php if($favoritesLink['disabled']): ?> aria-disabled="true" <?php endif; ?>>
        ...
        <a href="<?php echo e($cartLink['url']); ?>"
           class="nav-icon-button"
           aria-label="<?php echo e($cartLink['label']); ?>"
           title="<?php echo e($cartLink['label']); ?>"
           <?php if($cartLink['disabled']): ?> aria-disabled="true" <?php endif; ?>>
            ...
            <?php if(auth()->guard()->check()): ?>
                <div class="relative group">
                    <button id="userDropdownBtn" class="flex items-center px-3 py-2 bg-[#e0f7fa] rounded hover:bg-[#06b6d4] hover:text-white">
                        <?php echo e(Auth::user()->customer?->first_name ?? Auth::user()->email); ?>
                    ...
                    <div id="userDropdownMenu"
                        ...
                        <form id="customerLogoutForm" action="<?php echo e(route('customer.logout')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <button type="submit"
...
<div class="welcome-section">
  ...
  <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 grid grid-cols-1 md:grid-cols-5 gap-6">
    ...
    <aside class="sidebar rounded-2xl p-4 md:col-span-1 h-full">
      <nav class="space-y-2">
        ...
        ?>
        <div x-data="{ open: <?php echo e($myAccountActive ? 'true' : 'false'); ?> }" class="relative">
          <!-- Dropdown header with link + toggle -->
          <div class="flex items-stretch gap-2 group">
            <a href="<?php echo e(route('customerprofile.index')); ?>"
               class="nav-item flex items-center gap-3 px-4 py-3 rounded-xl transition w-full font-medium <?php echo e($myAccountActive ? 'bg-[#e0f7fa] text-gray-700' : 'text-gray-700 hover:bg-[#e0f7fa]'); ?>">
          ...
          <div x-show="open" @click.away="open = false" class="mt-1 ml-6 space-y-1">
            ...
            <!-- Addresses (with link) -->
            <a href="<?php echo e(route('customerprofile.addresses')); ?>"
               class="block px-4 py-2 text-gray-700 hover:bg-[#e0f7fa] rounded transition">
              Addresses
            </a>
            <!-- Change Password (with link) -->
            <a href="<?php echo e(route('customerprofile.change-password')); ?>"
               class="block px-4 py-2 text-gray-700 hover:bg-[#e0f7fa] rounded transition">
              Change Password
            </a>
        ...
        ?>
      <a href="<?php echo e(route('customer.my_purchase.completed')); ?>"
        class="nav-item flex items-center gap-3 px-4 py-3 rounded-xl transition <?php echo e($myPurchaseActive ? 'bg-[#e0f7fa] text-gray-700 font-medium' : 'text-gray-700 hover:bg-[#e0f7fa]'); ?>">
        ...
        <?php $favoritesActive = request()->routeIs('customer.favorites*'); ?>
        <a href="<?php echo e(route('customer.favorites')); ?>"
          class="nav-item flex items-center gap-3 px-4 py-3 rounded-xl transition <?php echo e($favoritesActive ? 'bg-[#e0f7fa] text-gray-700 font-medium' : 'text-gray-700 hover:bg-[#e0f7fa]'); ?>">
        ...
        <?php $notificationsActive = request()->routeIs('customer.notifications*'); ?>
        <a href="<?php echo e(route('customer.notifications')); ?>"
          class="nav-item flex items-center gap-3 px-4 py-3 rounded-xl transition <?php echo e($notificationsActive ? 'bg-[#e0f7fa] text-gray-700 font-medium' : 'text-gray-700 hover:bg-[#e0f7fa]'); ?>">
  ...
  <div class="absolute left-0 top-full mt-1 w-48 bg-white rounded shadow-lg z-10 hidden group-hover:block">
    <a href="<?php echo e(route('customerprofile.settings', ['tab' => 'account'])); ?>"

       class="block px-4 py-2 text-gray-700 hover:bg-[#e0f7fa] rounded transition">
      Account Settings
    </a>
    <a href="<?php echo e(route('customerprofile.settings', ['tab' => 'privacy'])); ?>"
...
(function () {
    const threadUrl = "<?php echo e(route('customer.chat.thread')); ?>";
    const sendUrl   = "<?php echo e(route('customer.chat.send')); ?>";
...
<script>
(function () {
    const unreadUrl = "<?php echo e(route('customer.chat.unread')); ?>";
    const markReadUrl = "<?php echo e(route('customer.chat.markread')); ?>";
...
<?php /**PATH C:\Users\leanne\xampp\htdocs\InkWise-Web\ink-wise\resources\views/layouts/customerprofile.blade.php ENDPATH**/ ?>