<?php $__env->startSection('title', 'In Production'); ?>
...
<div class="bg-white rounded-2xl shadow p-6">
    ...
    <div class="space-y-4">
        <?php $__empty_1 = true; $__currentLoopData = $inProductionOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <?php
            ...
            <div class="bg-white border rounded-xl p-4 shadow-sm flex flex-col gap-4 md:flex-row md:items-center">
                <img src="<?php echo e($image); ?>" alt="<?php echo e($productName); ?>" class="w-24 h-24 object-cover rounded-lg border">
                <div class="flex-1 space-y-1">
                    ...
                    <div class="text-sm text-gray-500">Quantity: <?php echo e($totalQuantity ?: '—'); ?> pcs</div>
                    <div class="text-sm text-gray-500">Primary paper: <?php echo e($paperStock); ?></div>
                    <div class="text-sm text-gray-500">Status: <span class="font-semibold text-[#a6b7ff]"><?php echo e($statusLabel); ?></span></div>
                    <?php if($paymentMethod): ?>
                        <div class="text-sm text-gray-500">Payment: <span class="font-semibold <?php echo e($paymentStatusRaw === 'paid' ? 'text-green-600' : ($paymentStatusRaw === 'partial' ? 'text-yellow-600' : 'text-gray-600')); ?>"><?php echo e(strtoupper($paymentMethod)); ?> - <?php echo e($paymentStatusLabel); ?></span></div>
                    <?php endif; ?>
                    <div class="text-sm text-gray-500">Next step: <?php echo e($nextStatusLabel ?? 'All steps complete'); ?></div>
                    <?php if($trackingNumber): ?>
                        <div class="text-sm text-gray-500">Tracking: <?php echo e($trackingNumber); ?></div>
                    <?php endif; ?>
                    <?php if($statusNote): ?>
                        <div class="text-xs text-gray-400">Note: <?php echo e($statusNote); ?></div>
                    <?php endif; ?>
                    <?php if($itemsCollection->isNotEmpty()): ?>
                        <div class="pt-2">
                            ...
                            <ul class="mt-1 space-y-1">
                                <?php $__currentLoopData = $itemsCollection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <li class="text-sm text-gray-500 flex flex-wrap gap-1">
                                        <span class="font-medium text-gray-600"><?php echo e($itemName); ?></span>
                                        <span>·</span>
                                        <span><?php echo e($itemQty > 0 ? $itemQty . ' pcs' : 'Qty —'); ?></span>
                                        <?php if($itemPaper): ?>
                                            <span>·</span>
                                            <span>Paper: <?php echo e($itemPaper); ?></span>
                                        <?php endif; ?>
                                    </li>
                    ...
                    <?php endif; ?>
                    <?php if($hasDesignEntries): ?>
                        <div id="<?php echo e($designToggleId); ?>" class="hidden pt-3 space-y-3">
                            <div class="text-xs font-semibold uppercase tracking-wide text-gray-400">Design proofs</div>
                            <?php $__currentLoopData = $designEntries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="space-y-1">
                                    <div class="text-sm font-medium text-gray-600"><?php echo e($entry['name']); ?></div>
                                    <div class="flex flex-wrap gap-2">
                                        <?php $__currentLoopData = $entry['images']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $designImage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <a href="<?php echo e($designImage); ?>" target="_blank" rel="noopener" class="group block">
                                                <img src="<?php echo e($designImage); ?>" alt="Design preview for <?php echo e($entry['name']); ?>" class="w-20 h-20 object-cover rounded border border-gray-200 group-hover:border-transparent group-hover:ring-2 group-hover:ring-[#a6b7ff] transition">
                                            </a>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
                    ...
                    <?php if($orderCustomerReview && !empty($orderCustomerReview->design_svg)): ?>
                        <?php
                        ...
                        ?>
                        <div class="mt-3 saved-template-card" data-order-number="<?php echo e($orderNumber); ?>">
                            ...
                            <div class="flex items-center gap-3 mt-2">
                                <div class="w-20 h-20 overflow-hidden rounded border border-gray-200 bg-slate-50 cursor-pointer hover:ring-2 hover:ring-[#a6b7ff] transition js-svg-preview-trigger"
                                     data-svg-id="svg-modal-<?php echo e($loop->index); ?>"
                                     data-back-image="<?php echo e($backImageUrl ?? ''); ?>">
                                    <div class="svg-container w-full h-full" style="pointer-events: none;">
                                        <?php echo $orderCustomerReview->design_svg; ?>

                                    </div>
                                </div>
                                <div class="flex-1 text-sm text-gray-600">
                                    <div class="font-medium"><?php echo e($templateMeta['template_name'] ?? $templateMeta['name'] ?? 'Saved template'); ?></div>
                                    <div class="text-xs text-gray-400">Click to view front & back</div>
                                </div>
                            </div>
                            
                            <template id="svg-modal-<?php echo e($loop->index); ?>"><?php echo $orderCustomerReview->design_svg; ?></template>
                        </div>
                    <?php elseif($templatePreview || count($templatePreviews)): ?>
                        <div class="mt-3 saved-template-card" data-order-number="<?php echo e($orderNumber); ?>">
                            <div class="text-xs font-semibold uppercase tracking-wide text-gray-400">Edited template</div>
                            <div class="flex items-center gap-3 mt-2">
                                <?php if($templatePreview): ?>
                                    <a href="<?php echo e($templatePreview); ?>" target="_blank" rel="noopener" class="block">
                                        <img src="<?php echo e($templatePreview); ?>" alt="Saved template preview" class="w-20 h-20 object-cover rounded border border-gray-200">
                                    </a>
                                <?php elseif(count($templatePreviews)): ?>
                                    <a href="<?php echo e($templatePreviews[0]); ?>" target="_blank" rel="noopener" class="block">
                                        <img src="<?php echo e($templatePreviews[0]); ?>" alt="Saved template preview" class="w-20 h-20 object-cover rounded border border-gray-200">
                                    </a>
                                <?php endif; ?>
                                <div class="flex-1 text-sm text-gray-600">
                                    <div class="font-medium"><?php echo e($templateMeta['template_name'] ?? $templateMeta['name'] ?? 'Saved template'); ?></div>
                ...
                <div class="flex flex-col items-end gap-2">
                    ...
                    <div class="text-sm text-red-500">Balance remaining: ₱<?php echo e(number_format($remainingBalance, 2)); ?></div>
                    <?php else: ?>
                    ...
                    <div class="flex gap-2">
                        ...
                        <?php if($hasRemainingBalance): ?>
                        <a href="<?php echo e(route('customer.pay.remaining.balance', ['order' => data_get($order, 'id')])); ?>"
                           class="px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded font-semibold transition-colors duration-200">
                            Pay Remaining (₱<?php echo e(number_format($remainingBalance, 2)); ?>)
                        </a>
                        <?php endif; ?>

                        <button type="button"
                                class="px-4 py-2 <?php echo e($hasDesignEntries ? 'bg-[#a6b7ff] hover:bg-[#8f9ffd] text-white' : 'bg-gray-200 text-gray-400 cursor-not-allowed'); ?> rounded font-semibold transition-colors duration-200"
                                <?php if($hasDesignEntries): ?>
                                    data-design-toggle="<?php echo e($designToggleId); ?>"
                                <?php else: ?>
                                    disabled
                                <?php endif; ?>>
                            View Design Proof<?php echo e($hasDesignEntries ? ($designEntries->count() > 1 ? 's' : '') : ''); ?>

                        </button>
                       
                       
                        <?php if($customerCanCancel): ?>
                        <button type="button" class="px-4 py-2 border border-red-500 text-red-500 hover:bg-red-50 rounded font-semibold js-cancel-production-order" data-order-id="<?php echo e(data_get($order, 'id')); ?>">Cancel Order</button>
                        <?php else: ?>
...
<?php echo $__env->make('layouts.customerprofile', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\leanne\xampp\htdocs\InkWise-Web\ink-wise\resources\views/customer/profile/purchase/inproduction.blade.php ENDPATH**/ ?>