...
>
	...
	<?php if($savedTemplate && !empty($savedGallery)): ?>
		<section class="status-info-card" style="margin-top:12px;">
			<h3 style="margin:0 0 8px 0;">Saved Template</h3>
			<div style="display:flex;gap:12px;align-items:center;">
				<img src="<?php echo e($savedTemplate['preview_image'] ?? ($savedGallery[0] ?? '')); ?>" alt="Saved template preview" style="max-width:220px;max-height:160px;object-fit:contain;border:1px solid #e6eef9;border-radius:8px;">
				<div>
					<div style="font-weight:600;margin-bottom:6px;"><?php echo e($savedTemplate['template_name'] ?? 'Saved template'); ?></div>
					<div style="color:#475569;font-size:0.95rem;margin-bottom:8px;">This template was saved by the customer.</div>
					<button type="button" class="btn btn-primary" data-preview-trigger data-preview-title="<?php echo e($savedTemplate['template_name'] ?? 'Saved template'); ?>" data-preview-gallery='<?php echo json_encode($savedGallery, 15, 512) ?>' data-preview-materials='[]'>
											...
											<div class="item-cell">
												...
												<?php if($gallery->isNotEmpty()): ?>
													<button
														...
														data-preview-gallery='<?php echo json_encode($gallery, 15, 512) ?>'
													...
													>
														<img src="<?php echo e($primaryImage); ?>" alt="<?php echo e($primaryImageLabel ? $previewTitle . ' ' . strtolower($primaryImageLabel) : $previewTitle . ' preview'); ?>" class="item-cell__thumb">
													</button>
												<?php elseif($primaryImage): ?>
													<div class="item-cell__thumb-fallback">
														<img src="<?php echo e($primaryImage); ?>" alt="<?php echo e($previewTitle); ?> preview" class="item-cell__thumb">
													</div>
												<?php endif; ?>
												<div>
				...
				<header class="ordersummary-card__header">
					...
					<div class="ordersummary-card__actions">
						<?php if($customerEmail && $customerId): ?>
							<a href="<?php echo e(route('staff.messages.index')); ?>?start_conversation=<?php echo e($customerId); ?>" class="btn btn-secondary btn-sm">
				...
				<div class="payment-info-grid">
					<div class="payment-info-card">
						...
						<dl>
							...
							<dt>Order date</dt>
							<dd><?php echo e($placedAt ?? 'Not available'); ?></dd>
							<dt>Total amount</dt>
							<dd><?php echo e($formatCurrencyAmount($orderGrandTotal)); ?></dd>
							<dt>Amount paid</dt>
							<dd><?php echo e($formatCurrencyAmount($totalPaid)); ?></dd>
							<dt>Balance due</dt>
							<dd><?php echo e($formatCurrencyAmount($balanceDue)); ?></dd>
							<dt>Payment status</dt>
							<dd><?php echo e($currentPaymentStatusLabel); ?></dd>
							<dt>Last updated</dt>
							<dd><?php echo e($lastUpdatedDisplay ?? 'Not available'); ?></dd>
							<?php if($primaryPaymentMethod): ?>
								<dt>Payment method</dt>
								<dd><?php echo e(mb_strtoupper($primaryPaymentMethod)); ?></dd>
							<?php endif; ?>
							<?php if($primaryPaymentProvider): ?>
								<dt>Payment provider</dt>
								<dd><?php echo e(ucfirst($primaryPaymentProvider)); ?></dd>
							<?php endif; ?>
							<?php if($latestPaymentDisplay): ?>
								<dt>Latest payment</dt>
								<dd><?php echo e($latestPaymentDisplay); ?></dd>
							<?php endif; ?>
							<?php if($paymentNote): ?>
								<dt>Payment note</dt>
					...
					<div class="payment-info-card">
						...
						<div class="payment-info-card__text">
							...
							<?php if($primaryPaymentMethod || $primaryPaymentProvider): ?>
								<p>
									<?php if($primaryPaymentMethod): ?>
										Primary method: <strong><?php echo e(mb_strtoupper($primaryPaymentMethod)); ?></strong>
									<?php endif; ?>
									<?php if($primaryPaymentMethod && $primaryPaymentProvider): ?>
										 · 
									<?php endif; ?>
									<?php if($primaryPaymentProvider): ?>
										Provider: <strong><?php echo e(ucfirst($primaryPaymentProvider)); ?></strong>
									<?php endif; ?>
								</p>
							<?php endif; ?>
						</div>
		...
		>
			<section class="sidebar-card sidebar-card--totals">
				...
				<div class="payment-status-highlight" style="background: #f0f9ff; border: 2px solid #0ea5e9; border-radius: 8px; padding: 16px; margin-bottom: 16px; text-align: center;">
					...
					<span class="status-chip <?php echo e('status-chip--' . $paymentStatus); ?>" style="font-size: 16px; padding: 8px 16px;">
						<?php echo e(ucfirst($paymentStatus ?: 'pending')); ?>
				...
				<div class="payment-summary-grid">
					<div class="payment-summary-grid__item">
						...
						<span class="payment-summary-grid__value"><?php echo e($formatCurrencyAmount($orderGrandTotal)); ?></span>
					</div>
					<div class="payment-summary-grid__item">
						<span class="payment-summary-grid__label">Total paid</span>
						<span class="payment-summary-grid__value"><?php echo e($formatCurrencyAmount($totalPaid)); ?></span>
					</div>
					<div class="payment-summary-grid__item">
						<span class="payment-summary-grid__label">Balance remaining</span>
						<span class="payment-summary-grid__value"><?php echo e($formatCurrencyAmount($balanceDue)); ?></span>
					</div>
					<?php if($primaryPaymentMethod): ?>
						<div class="payment-summary-grid__item">
							<span class="payment-summary-grid__label">Payment method</span>
							<span class="payment-summary-grid__value"><?php echo e(mb_strtoupper($primaryPaymentMethod)); ?></span>
						</div>
					<?php endif; ?>
					<?php if($primaryPaymentProvider): ?>
						<div class="payment-summary-grid__item">
							<span class="payment-summary-grid__label">Provider</span>
							<span class="payment-summary-grid__value"><?php echo e(ucfirst($primaryPaymentProvider)); ?></span>
						</div>
					<?php endif; ?>
					<?php if($latestPaymentDisplay): ?>
						<div class="payment-summary-grid__item">
							<span class="payment-summary-grid__label">Latest payment</span>
							<span class="payment-summary-grid__value"><?php echo e($latestPaymentDisplay); ?></span>
						</div>
					<?php endif; ?>
				</div>
				<?php if($orderGrandTotal > 0): ?>
					...
					<?php elseif($balanceDue > 0.01): ?>
						<div class="payment-alert payment-alert--balance">Remaining balance of <?php echo e($formatCurrencyAmount($balanceDue)); ?> is pending.</div>
					<?php else: ?>
				...
				<dl class="sidebar-totals" data-sidebar-section>
					...
					<div>
						...
						?>
						<dd data-money><?php echo e(number_format($sidebarSubtotal, 2)); ?></dd>
					</div>
					<div class="sidebar-totals__total">
						<dt>Total due</dt>
						<dd data-grand-total data-money><?php echo e(number_format($sidebarGrandTotal, 2)); ?></dd>
					</div>
				</dl>
					...
					<div class="payment-history">
						...
						<?php $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							...
							<div class="payment-history__row">
								<div>
									<div class="payment-history__amount"><?php echo e($formatCurrencyAmount($paymentAmount)); ?></div>
									<?php if($metaPieces !== ''): ?>
										<div class="payment-history__meta"><?php echo e($metaPieces); ?></div>
									<?php endif; ?>
								</div>
								<span class="payment-history__status payment-history__status--<?php echo e($statusClass); ?>"><?php echo e(ucfirst($paymentStatusRow)); ?></span>
							</div>
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					</div>
				<?php endif; ?>
...
<?php echo $__env->make('layouts.staffapp', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\leanne\xampp\htdocs\InkWise-Web\ink-wise\resources\views/staff/order/show.blade.php ENDPATH**/ ?>