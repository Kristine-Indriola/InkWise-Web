...
<?php $__env->startSection('title', 'Wedding Invitations'); ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            window.productRatings = <?php echo json_encode($ratingsData, 15, 512) ?>;
        ...
        <div class="layout-container">
            <div class="invitation-grid" role="list">
                <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    ?>
                    <article class="invitation-card" role="listitem" data-product-id="<?php echo e($product->id); ?>">
                        <button type="button"
                                class="favorite-toggle"
                                data-product-id="<?php echo e($product->id); ?>"
                                aria-label="Save <?php echo e($product->name); ?> to favorites"
                                aria-pressed="false">
                            ...
                            <img src="<?php echo e($previewSrc); ?>"
                                alt="<?php echo e($product->name); ?> invitation design"
                                class="invitation-card__image preview-trigger"
                                loading="lazy"
                                data-product-id="<?php echo e($product->id); ?>"
                                data-preview-url="<?php echo e($previewUrl); ?>"
                                data-template="<?php echo e($product->name); ?>"
                                data-reflection>
                        <div class="invitation-card__info preview-trigger"
                             ...
                             role="button"
                             tabindex="0">
                            <h3 class="invitation-card__name"><?php echo e(\Illuminate\Support\Str::limit($product->name, 28)); ?></h3>
                            <span class="invitation-card__price-tag">
                                <?php if(!is_null($priceValue)): ?>
                                    ₱<?php echo e(number_format($priceValue, 2)); ?>
                            ...
                            <div class="invitation-card__ratings rating-trigger"
                                 ...
                                 tabindex="0"
                                 data-product-id="<?php echo e($product->id); ?>"
                                 aria-label="<?php echo e($ratingCount > 0 ? 'View reviews for '.$product->name : 'Be the first to review '.$product->name); ?>">
                                <?php if($ratingCount > 0): ?>
                                    ...
                                    <div class="invitation-card__rating-stars" aria-hidden="true">
                                        <?php for($star = 1; $star <= 5; $star++): ?>
                                            <span class="invitation-card__rating-star <?php echo e($star <= $roundedAverage ? 'filled' : ''); ?>">★</span>
                                        <?php endfor; ?>
                                    </div>
                                    <span class="invitation-card__rating-detail">
                                        <?php echo e(number_format($averageRating ?? 0, 1)); ?> · <?php echo e($ratingCount); ?> review<?php echo e($ratingCount === 1 ? '' : 's'); ?>
...
<?php echo $__env->make('customer.Invitations.invitations', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\leanne\xampp\htdocs\InkWise-Web\ink-wise\resources\views/customer/Invitations/weddinginvite.blade.php ENDPATH**/ ?>