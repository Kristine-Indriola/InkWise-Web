<?php $__env->startSection('title', 'Manage FAQ'); ?>

<?php $__env->startPush('styles'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('css/admin-css/materials.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/admin-css/chatbot.css')); ?>">
<?php $__env->stopPush(); ?>
...
<main class="admin-page-shell chatbot-page" role="main">
    ...
    <section class="summary-grid chatbot-summary" aria-label="Chatbot highlights">
        <article class="summary-card summary-card--knowledge">
            ...
            <div class="summary-card-body">
                <span class="summary-card-value" data-summary="total" data-total="<?php echo e($totalEntries); ?>"><?php echo e(number_format($totalEntries)); ?></span>
        ...
        <article class="summary-card summary-card--media">
            ...
            <div class="summary-card-body">
                <span class="summary-card-value" data-summary="media" data-total-media="<?php echo e($entriesWithImage); ?>"><?php echo e(number_format($entriesWithImage)); ?></span>
        ...
        <article class="summary-card summary-card--updated">
            ...
            <div class="summary-card-body">
                <span class="summary-card-value" data-summary="updated" data-initial-updated="<?php echo e($lastUpdated ? e(optional($lastUpdated)->diffForHumans()) : '—'); ?>"><?php echo e($lastUpdated ? optional($lastUpdated)->diffForHumans() : '—'); ?></span>
    ...
    <section class="materials-toolbar chatbot-toolbar" aria-label="Chatbot utilities">
        ...
        <p class="chatbot-toolbar__hint" id="chatbotEntriesHint" data-total="<?php echo e($totalEntries); ?>">
            <strong><?php echo e(number_format($totalEntries)); ?></strong> FAQs available.
        </p>
    </section>
    ...
    <div class="chatbot-grid">
        <section id="chatbotForm" class="chatbot-card chatbot-card--form" tabindex="-1" aria-labelledby="chatbotFormTitle">
            ...
            <form action="<?php echo e(route('admin.chatbot.store')); ?>" method="POST" class="chatbot-form" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="form-group">
                    <label for="createQuestion">Question</label>
                    <input id="createQuestion" type="text" name="question" class="form-control" value="<?php echo e(old('question')); ?>" required>
                </div>
                <div class="form-group">
                ...
                <table class="table table-hover" id="qasTable" role="grid">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $qas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $qa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="qa-row"
                                data-id="<?php echo e($qa->id); ?>"
                                data-question="<?php echo e(htmlentities($qa->question, ENT_QUOTES, 'UTF-8')); ?>"
                                data-answer="<?php echo e(htmlentities($qa->answer, ENT_QUOTES, 'UTF-8')); ?>"
                                data-image-url="<?php echo e($qa->answer_image_path ? htmlentities(asset('storage/' . $qa->answer_image_path), ENT_QUOTES, 'UTF-8') : ''); ?>"
                                data-has-image="<?php echo e($qa->answer_image_path ? 'true' : 'false'); ?>"
                                data-updated="<?php echo e(optional($qa->updated_at)->toIso8601String()); ?>"
                                data-updated-human="<?php echo e(optional($qa->updated_at)->diffForHumans()); ?>">
                                <td class="qa-question"><?php echo e($qa->question); ?></td>
                                <td class="qa-answer">
                                    <?php echo e(\Illuminate\Support\Str::limit(strip_tags($qa->answer), 200)); ?>

                                    <?php if($qa->answer_image_path): ?>
                                        <div class="qa-answer-media text-muted small">📎 Image attached</div>
                                    <?php endif; ?>
                                </td>
                                <td class="text-center">
                                    <button type="button" class="btn btn-sm btn-warning edit-qa" title="Edit" data-id="<?php echo e($qa->id); ?>">Edit</button>

                                    <form action="<?php echo e(route('admin.chatbot.destroy', $qa->id)); ?>" method="POST" class="inline-form">
                                        <?php echo csrf_field(); ?>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const updateUrlTemplate = <?php echo json_encode(route('admin.chatbot.update', ['qa' => '__ID__']), 512) ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\leanne\xampp\htdocs\InkWise-Web\ink-wise\resources\views/admin/chatbot/index.blade.php ENDPATH**/ ?>