...
<main class="py-12 px-6 text-center">
    ...
    <!-- Wedding Dropdown Button -->
    <div class="relative inline-block text-left group">
        <button id="weddingDropdownBtn" class="z-10 px-4 py-2 font-semibold text-[#06b6d4] focus:outline-none">
            Wedding
        </button>
        <div id="weddingDropdownMenu"
             class="absolute left-0 mt-2 w-48 bg-white border border-[#e0f7fa] rounded shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200"
             style="top:100%;">
            <!-- Dropdown content here -->
            <a href="{{ route('templates.wedding.invitations') }}" class="block px-4 py-2 hover:bg-[#e0f7fa]">Wedding</a>
            <a href="{{ route('templates.corporate.invitations') }}" class="block px-4 py-2 hover:bg-[#e0f7fa]">Corporate</a>
            <a href="{{ route('templates.baptism.invitations') }}" class="block px-4 py-2 hover:bg-[#e0f7fa]">Baptism</a>
            <a href="{{ route('templates.birthday.invitations') }}" class="block px-4 py-2 hover:bg-[#e0f7fa]">Birthday</a>
        </div>
    </div>
</main>
@endsection
