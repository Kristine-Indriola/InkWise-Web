        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <article class="group bg-white rounded-2xl shadow hover:shadow-2xl transition p-4">
                <figure class="overflow-hidden rounded-xl">
                    <img src="{{ asset('costumerimage/wedding/invite1.jpg') }}" alt="Classic Florals"
...
<div class="flex justify-center gap-3 mt-3 color-swatches">
    ...
    <span class="w-5 h-5 rounded-full border bg-slate-700 cursor-pointer" data-color="#334155"></span>
            ...
            <article class="group bg-white rounded-2xl shadow hover:shadow-2xl transition p-4">
                <figure class="overflow-hidden rounded-xl">
                    <img src="{{ asset('costumerimage/wedding/invite2.jpg') }}" alt="Minimal Monogram"
                         class="w-full h-80 object-cover transform group-hover:scale-105 transition duration-500">
                </figure>
                <div class="pt-4 text-center">
            ...
            <article class="group bg-white rounded-2xl shadow hover:shadow-2xl transition p-4">
                <figure class="overflow-hidden rounded-xl">
                    <img src="{{ asset('costumerimage/invite3.png') }}" alt="Sunset Save the Date"
                         class="w-full h-80 object-cover transform group-hover:scale-105 transition duration-500">
                </figure>
                <div class="pt-4 text-center">
            ...
            <article class="group bg-white rounded-2xl shadow hover:shadow-2xl transition p-4">
                <figure class="overflow-hidden rounded-xl">
                    <img src="{{ asset('costumerimage/wedding/invite4.jpg') }}" alt="Modern Arch"
                         class="w-full h-80 object-cover transform group-hover:scale-105 transition duration-500">
                </figure>
                <div class="pt-4 text-center">
            ...
            <article class="group bg-white rounded-2xl shadow hover:shadow-2xl transition p-4">
                <figure class="overflow-hidden rounded-xl">
                    <img src="{{ asset('costumerimage/wedding/invite5.jpg') }}" alt="Luxe Foil Look"
                         class="w-full h-80 object-cover transform group-hover:scale-105 transition duration-500">
                </figure>
                <div class="pt-4 text-center">
