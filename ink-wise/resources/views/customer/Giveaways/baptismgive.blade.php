...
@section('title', 'Baptism Giveaways')
...
@push('styles')
    ...
    <style>
        :root {
            --give-accent: #bfdbfe;
            --give-accent-dark: #60a5fa;
            --give-surface: #ffffff;
            --give-muted: #64748b;
            --give-shadow: 0 24px 48px rgba(96, 165, 250, 0.2);
        }
        ...
        .giveaway-gallery::before {
            ...
            position: absolute;
            inset: 0;
            background: radial-gradient(circle at top, rgba(191, 219, 254, 0.25), transparent 55%);
            pointer-events: none;
        }
        ...
        .giveaway-card:hover {
            ...
            filter: drop-shadow(0 12px 25px rgba(30, 64, 175, 0.2));
        }
        ...
        .favorite-toggle:focus-visible {
            ...
            box-shadow: 0 18px 32px rgba(96, 165, 250, 0.35);
        }

        .favorite-toggle.is-active {
            background: linear-gradient(135deg, #93c5fd, #60a5fa);
            color: #ffffff;
            box-shadow: 0 20px 36px rgba(96, 165, 250, 0.45);
        }
...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            const FAVORITES_KEY = 'inkwise:baptism:giveaways:favorites';
            let favorites;
            ...
            try {
                ...
                console.warn('Unable to parse baptism giveaway favorites from storage.', error);
                favorites = new Set();
            }
...
<main class="giveaway-page">
    <section class="giveaway-hero">
        <div class="giveaway-hero__content">
            <h1 class="giveaway-hero__title">BAPTISM GIVEAWAYS</h1>
            <p class="giveaway-hero__subtitle">BLESS YOUR CELEBRATION</p>
        </div>
    </section>
        ...
        <div class="layout-container">
            @if(!$hasProducts)
                <div class="giveaway-empty">
                    ...
                    <p>We’re preparing keepsakes for sacred milestones. Check back soon or message us for a custom concept.</p>
                </div>
            @else
