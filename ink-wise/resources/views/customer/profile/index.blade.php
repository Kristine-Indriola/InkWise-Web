...
<div class="flex gap-3">
    ...
    <div class="pt-2 flex items-center gap-4">
      ...
      <a href="{{ route('customerprofile.change-password') }}"
        class="px-5 py-2.5 rounded-xl border-2 border-orange-500 text-orange-500 font-medium hover:bg-orange-50 transition duration-200 inline-flex items-center gap-2">
