...
<header class="shadow animate-fade-in-down glass-nav w-full">
    <div class="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 flex items-center justify-between h-14 relative">
        ...
        <nav id="mainNav" class="hidden md:flex space-x-4 absolute left-[54%] transform -translate-x-1/2" role="navigation">
            <a href="{{ route('home') }}" class="text-sm text-gray-700 hover:text-[#06b6d4] font-medium transition-colors">Home</a>
            <a href="{{ route('categories') }}" class="text-sm text-gray-700 hover:text-[#06b6d4] font-medium transition-colors">Categories</a>
            <a href="{{ route('templates') }}" class="text-sm text-gray-700 hover:text-[#06b6d4] font-medium transition-colors">Templates</a>
            <a href="{{ route('about') }}" class="text-sm text-gray-700 hover:text-[#06b6d4] font-medium transition-colors">About</a>
            <a href="{{ route('contact') }}" class="text-sm text-gray-700 hover:text-[#06b6d4] font-medium transition-colors">Contact</a>
        </nav>
    ...
    {{-- If not logged in --}}
@guest
    <a href="{{ route('dashboard', ['modal' => 'login']) }}"
            id="openLogin"
        ...
        <div class="hero-grid relative z-10">
            ...
            <div class="hero-copy animate-fade-in-right">
                ...
                <div class="hero-actions">
                    ...
                    @else
                        <a href="{{ route('dashboard', ['modal' => 'login']) }}" class="btn-pill btn-primary focus-ring">Order Now</a>
                    @endauth
