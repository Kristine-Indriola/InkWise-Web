  ...
  <div class="page-inner">
    <div class="panel">
      ...
      <div id="approvedSection" class="fade show">
        ...
        <!-- Back Arrow (same style as Pending Staff back button) -->
            ...
            <tbody>
              @forelse($pendingStaff as $staff)
                <tr>
                  ...
                  <td>{{ $staff->contact_number }}</td>
                  <td>
                    <form action="{{ route('owner.staff.approve', $staff->staff_id) }}" method="POST" style="display:inline">@csrf
                      <button type="submit" class="btn btn-success">✅ Approve</button>
                    </form>
                    <form action="{{ route('owner.staff.reject', $staff->staff_id) }}" method="POST" style="display:inline"
...
(function() {
  ...
  pendingBtn.addEventListener('click', function() {
    // Hide approved and show pending
