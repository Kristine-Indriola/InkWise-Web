...
<div class="max-w-4xl mx-auto bg-white p-8 rounded-xl shadow-lg mt-10">
    <h2 class="text-2xl font-bold mb-6">Pending Staff Accounts</h2>
            ...
            <tbody>
                @foreach($pendingStaff as $staff)
                    <tr class="hover:bg-gray-50">
                        <td class="p-3 border">{{ $staff->first_name }} {{ $staff->last_name }}</td>
                        ...
                        <td class="p-3 border flex gap-2">
                            ...
                            <form action="{{ route('owner.staff.reject', $staff->staff_id) }}" method="POST" 
                                  onsubmit="return confirm('Are you sure you want to reject this account?');">
                                @csrf
