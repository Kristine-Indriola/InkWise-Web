...
<style>
    ...
    .owner-products-page .product-view-header h1 {
                    font-size: 1.75rem;
                    font-weight: 800;
    }

    .owner-products-page .product-view-header .back-link {
        font-size: 0.9rem;
    }

    .owner-products-page .product-tagline,
    .owner-products-page .summary-label,
    .owner-products-page .summary-card .summary-label,
    .owner-products-page .summary-card .summary-value,
                .owner-products-page .product-card,
                .owner-products-page .product-card .meta-list li,
                .owner-products-page .product-card .product-description,
                .owner-products-page .product-card .meta-pill {
                font-size: 0.95rem;
    }
    ...
    .owner-products-page .product-summary .summary-label {
            font-size: 1.15rem;
    }
</style>

<section class="main-content owner-dashboard-shell">
    <main class="materials-page admin-page-shell owner-dashboard-main owner-products-page" role="main">
    <div class="page-inner owner-dashboard-inner">
      <div class="product-view-wrapper owner-product-view">
        <header class="product-view-header">
            <div class="product-view-header__text">
                <a href="{{ route('owner.products.index') }}" class="back-link" aria-label="Back to product list">
                    ...
                    <div class="product-card uploads-card">
                        ...
                        <ul class="uploads-list">
                            @foreach($product->uploads as $upload)
                                @php
                                    $fileUrl = \Illuminate\Support\Facades\Storage::url('uploads/products/' . $product->id . '/' . $upload->filename);
