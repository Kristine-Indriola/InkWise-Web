<div 
    ...
    role="listitem"
    tabindex="0"
    data-view-url="{{ route('owner.products.show', $product->id) }}"
    data-id="{{ $product->id }}"
...
>
    ...
    <div class="product-card-footer">
        ...
        <div class="card-actions">
            <a href="{{ route('owner.products.show', $product->id) }}" class="btn-view" title="View {{ $product->name }}" aria-label="View {{ $product->name }}"><i class="fi fi-sr-eye"></i></a>
        </div>
    </div>
