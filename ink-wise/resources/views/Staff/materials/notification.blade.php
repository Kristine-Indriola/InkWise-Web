                ...
                <tbody>
                    @foreach($lowStock as $material)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('staff.materials.edit', $material->material_id) }}" class="btn btn-sm btn-warning">Restock</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
                ...
                <tbody>
                    @foreach($outOfStock as $material)
                        <tr>
                            ...
                            <td>{{ $material->inventory->reorder_level }}</td>
                            <td>
                                <a href="{{ route('staff.materials.edit', $material->material_id) }}" class="btn btn-sm btn-danger">Restock</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
