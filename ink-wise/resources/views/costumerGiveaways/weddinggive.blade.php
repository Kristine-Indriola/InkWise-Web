...
<!-- JS -->
<script src="{{ asset('js/costumertemplate.js') }}"></script>
    ...
    <main class="py-12 px-6 text-center">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div class="template-card shadow-lg rounded-2xl overflow-hidden bg-white hover:shadow-2xl transition">
                <img src="/costumerimage/glass.png" alt="Glass Souvenir" class="w-full h-48 object-cover">
                <div class="p-4">
            ...
            <!-- Giveaway 2 -->
            <div class="template-card shadow-lg rounded-2xl overflow-hidden bg-white hover:shadow-2xl transition">
                <img src="/costumerimage/pouch.png" alt="Wedding Pouch" class="w-full h-48 object-cover">
                <div class="p-4">
            ...
            <!-- Giveaway 3 -->
            <div class="template-card shadow-lg rounded-2xl overflow-hidden bg-white hover:shadow-2xl transition">
                <img src="/costumerimage/candle.png" alt="Wedding Candle" class="w-full h-48 object-cover">
                <div class="p-4">
            ...
            <!-- Giveaway 4 -->
            <div class="template-card shadow-lg rounded-2xl overflow-hidden bg-white hover:shadow-2xl transition">
                <img src="/costumerimage/keychain.png" alt="Wedding Keychain" class="w-full h-48 object-cover">
                <div class="p-4">
            ...
            <!-- Giveaway 5 -->
            <div class="template-card shadow-lg rounded-2xl overflow-hidden bg-white hover:shadow-2xl transition">
                <img src="/costumerimage/mini-plant.png" alt="Mini Plant" class="w-full h-48 object-cover">
                <div class="p-4">
