...
<body class="antialiased bg-gray-50 baptism">
...
<button 
    ...
    <main class="py-8 px-4">
        <div class="template-container text-center ">
           <h1 class="page-title">
                     <span class="cursive">B</span>aptism 
            ...
            <div class="cards-grid">
                ...
                <div class="template-card" onclick="openTemplateModal('invitation')">
                    <img src="/costumerimage/template.png" alt="Wedding Invitation" class="card-image">
                ...
                <div class="template-card" onclick="openTemplateModal('giveaways')">
                    <img src="/costumerimage/baptism.png" alt="Wedding Giveaway" class="card-image">
                    <div class="card-overlay">
