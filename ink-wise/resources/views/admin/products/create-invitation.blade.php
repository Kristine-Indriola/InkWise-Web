    ...
    200 pcs = ₱xx each" aria-describedby="bulkPricing-error"></textarea>
            ...
            <div class="form-section">
                ...
                <div class="sample-image">
                    <p>Sample Image:</p>
                    <img src="{{ asset('customerimages/image/invite1.png') }}" alt="Sample Invitation" style="max-width: 200px; border: 1px solid #ddd; padding: 5px;">
                </div>
            </div>
        ...
        <div class="page page3" style="display: none;">
            ...
            <div class="form-buttons">
                ...
                <button type="button" class="btn-cancel">Cancel</button>
                <button type="submit" class="btn-save">Show in Customer Page</button>
            </div>
        </div>
    </div>
</div>
...
<script src="{{ asset('js/admin-js/create_invite.js') }}"></script>
@endsection
