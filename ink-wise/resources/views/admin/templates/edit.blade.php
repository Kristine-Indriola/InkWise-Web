        ...
        document.querySelector('.edit-form').addEventListener('submit', function(e) {
            ...
            fetch(form.getAttribute('action'), {
                ...
                if (json && json.success) {
                    alert('Template updated successfully. Redirecting to templates list.');
...
<main class="dashboard-container templates-page" role="main">
    <section class="create-container" aria-labelledby="edit-template-heading">
        ...
        <form action="{{ route('admin.templates.update', $template->id) }}" method="POST" class="edit-form" enctype="multipart/form-data">
            @csrf
            @method('PUT')
