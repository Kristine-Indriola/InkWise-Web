  ...
  <div class="reviews-container">
    <header class="reviews-header">
      ...
      <div class="page-header__quick-actions">
        <a href="{{ route('admin.dashboard') }}" class="pill-link">← Back to Dashboard</a>
      </div>
    </header>
            ...
            <div class="staff-reply">
              ...
              @if($review->staffReplyBy)
                <small style="color: var(--admin-text-secondary); font-weight: 500;">
                  Replied by: {{ $review->staffReplyBy->name }}
                  @if($review->staffReplyBy->staff)
                    <span class="staff-id">(ID: {{ $review->staffReplyBy->staff->staff_id }})</span>
                  @endif
                  <span class="user-role {{ $review->staffReplyBy->role }}">
                    ({{ ucfirst($review->staffReplyBy->role) }})
                  </span>
                </small>
              @endif
            </div>
