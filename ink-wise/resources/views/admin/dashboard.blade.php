        ...
        <article class="dashboard-card">
            ...
            <div class="behavior-chart">
                <div class="insight-chart insight-chart--compact insight-chart--slim" style="margin:0;">
                    ...
                    <canvas id="ratingDistributionChart" data-chart='@json($ratingDistributionChart)'></canvas>
                    <p id="ratingDistributionEmpty" class="chart-card__empty" @if($ratingDistributionHasData) hidden @endif>Review data will appear once customers submit ratings.</p>
                </div>
                <span class="insight-meta-caption" style="display:block; margin-top:0.4rem;">
                    @if($customerReviewSnapshot['average'])
                        Average rating: {{ $customerReviewSnapshot['average'] }}★ ({{ number_format($customerReviewSnapshot['count']) }} reviews).
                    @else
                        No reviews yet.
                    @endif
                </span>
