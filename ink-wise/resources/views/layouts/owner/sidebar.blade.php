...
<aside class="sidebar" id="sidebar" style="padding-top:32px;">
  ...
  <ul id="ownerReportsSubmenu" class="sidebar-sublist">
    ...
    <li>
      <a href="{{ route('owner.settings.site-content.edit') }}">
        <button class="sidebar-btn {{ request()->routeIs('owner.settings.site-content.*') ? 'active' : '' }}">
          <span class="ico">
            <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
          ...
          <span class="text">Site Content</span>
        </button>
      </a>
    </li>
  </ul>
